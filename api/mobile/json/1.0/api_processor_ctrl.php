...
//    }
    ...
    {
        $objAPIProcessor = new APIProcessor();
        //print_r($_REQUEST['json_data']);die;
        //print_r(stripslashes(html_entity_decode($_REQUEST['json_data'])));die;
        $json_data = urldecode($_REQUEST['json_data']);
        //print_r($json_data);die;
        $arrData = json_decode(stripslashes(html_entity_decode($json_data)), true);
        
        if ($arrData['method'] == 'getAllCategories' || $arrData['method'] == 'getLogin' || $arrData['method'] == 'getPassword' || $arrData['method'] == 'registerUser' || $arrData['method'] == 'getCountryList'
                ...
                || $arrData['method'] == 'getMostTrending' || $arrData['method'] == 'getRecentlyViewed' || $arrData['method'] == 'makeReview' || $arrData['method'] == 'getProductDetails' || $arrData['method'] == 'getMenuByCategoryId'
                || $arrData['method'] == 'getMegaMenu' || $arrData['method'] == 'getParentMenu' || $arrData['method'] == 'getHomeScreenData' || $arrData['method'] == 'getTodayOffer' || $arrData['method'] == 'getTMOffers'
                ...
                || $arrData['method'] == 'getRewards' || $arrData['method'] == 'getCreditRewards' || $arrData['method'] == 'getDebitRewards' || $arrData['method'] == 'getWishList' || $arrData['method'] == 'getWishListLocal' || $arrData['method'] == 'getLatestProducts'
                || $arrData['method'] == 'getCustomerReview' || $arrData['method'] == 'getIphoneMegaMenu' || $arrData['method'] == 'getSupport'
                || $arrData['method'] == 'checkMegaMenuUpdate' || $arrData['method'] == 'cartDetails' || $arrData['method'] == 'savelist' || $arrData['method'] =='wholesalerProducts' || $arrData['method'] =='getAlsoLike' || $arrData['method']=='cartManage' 
                || $arrData['method']=='savelistAdd' || $arrData['method']=='myWishlistDelete' || $arrData['method']=='addWishlist' || $arrData['method']=='delWishlist' || $arrData['method']=='getWishListProductDetails' || $arrData['method']=='getTopRatedById' 
                || $arrData['method']=='getLatestProductByCatId' || $arrData['method']=='getAllLatestProductByCatId' || $arrData['method']=='getAllBestSellerByCatId' || $arrData['method']=='getAllTopRatedById' || $arrData['method']=='getSpecialBanner' || $arrData['method']=='getProductDetailsBySubCat' || $arrData['method']=='clearWishlist' || $arrData['method']=='addCart' || $arrData['method']=='getFilterResults'
                || $arrData['method']=='addCustomerReview' || $arrData['method']=='getCustomerOrderlist' || $arrData['method']=='updateCart' || $arrData['method']=='getWholeseller' || $arrData['method']=='getDisputeList' || $arrData['method']=='getDisputeHistory' || $arrData['method']=='addOrderInDispute' || $arrData['method']=='sendSupportMail' || $arrData['method']=='getProductPrice' || $arrData['method']=='filterData' 
                || $arrData['method']=='checkShippingAvilable' || $arrData['method']=='changeCurrency' || $arrData['method']=='getCurrencyList' || $arrData['method']=='leftMenu' || $arrData['method']=='getCustomerOrderDetails' || $arrData['method']=='shipping' || $arrData['method']=='getStock' || $arrData['method'] == 'getpaypalUrl' || $arrData['method'] == 'getShippingInfo' || $arrData['method'] == 'updateShippingAddress')
        {
            $arrRes = $this->getResponse($arrData);
        }
        else
    ...
    { 
        ...
        switch ($method)
        {
            ...
            case 'getWishList';
                ...
                break;
            case 'getWishListLocal';
                $arrRes['data'] = $objAPIProcessor->getWishListLocal($arrRequest);
                break;
            case 'contactUs';
			...
			case 'getShippingInfo';
                $arrRes['data'] = $objAPIProcessor->getShippingInfo($arrRequest);
                break;
			case 'updateShippingAddress';
                $arrRes['data'] = $objAPIProcessor->updateShippingAddress($arrRequest);
                break;					
            case 'updateprofile';
            ...
            case 'getProductDetails';
                ...
                break;
           case 'getMenuByCategoryId';
                $arrRes['data'] = $objAPIProcessor->getMenuByCategoryId($arrRequest);
                break;
            case 'getMegaMenu';
            ...
            case 'getTodayOffer';
                ...
                break;
            case 'getTMOffers';
                $arrRes['data'] = $objAPIProcessor->getTMOffers($arrRequest);
                break;
            case 'getBestSeller';
            ...
            case 'getLatestProductByCatId';
                ...
                break;
            case 'getAllLatestProductByCatId';
                $arrRes['data'] = $objAPIProcessor->getAllLatestProductByCatId($arrRequest);
                break;
            case 'getAllBestSellerByCatId';
                $arrRes['data'] = $objAPIProcessor->getAllBestSellerByCatId($arrRequest);
                break;
            case 'getAllTopRatedById';
                $arrRes['data'] = $objAPIProcessor->getAllTopRatedById($arrRequest);
                break;
            ...
            case 'getCustomerOrderlist';
                ...
                break;
            case 'updateCart';
                $arrRes['data'] = $objAPIProcessor->updateCart($arrRequest);
                break;
            case 'getWholeseller';
                $arrRes['data'] = $objAPIProcessor->getWholeseller($arrRequest);
                break;
			case 'getDisputeList';
                $arrRes['data'] = $objAPIProcessor->getDisputeList($arrRequest);
                break;
			case 'getDisputeHistory';
                $arrRes['data'] = $objAPIProcessor->getDisputeHistory($arrRequest);
                break;	
            case 'addOrderInDispute';
                $arrRes['data'] = $objAPIProcessor->addOrderInDispute($arrRequest);
                break;			
            case 'sendSupportMail';
                $arrRes['data'] = $objAPIProcessor->sendSupportMail($arrRequest);
                break;			
            case 'getProductPrice';
                $arrRes['data'] = $objAPIProcessor->getProductPrice($arrRequest);
                break;
            case 'filterData';
                $arrRes['data'] = $objAPIProcessor->filterData($arrRequest);
                break;
            case 'checkShippingAvilable';
                $arrRes['data'] = $objAPIProcessor->checkShippingAvilable($arrRequest);
                break;
            case 'changeCurrency';
                $arrRes['data'] = $objAPIProcessor->changeCurrency($arrRequest);
                break;
            case 'getCurrencyList';
                $arrRes['data'] = $objAPIProcessor->getCurrencyList($arrRequest);
                break;
            case 'leftMenu';
                $arrRes['data'] = $objAPIProcessor->leftMenu($arrRequest);
                break;
            case 'getCustomerOrderDetails';
                $arrRes['data'] = $objAPIProcessor->getCustomerOrderDetails($arrRequest);
                break;
            case 'shipping';
                $arrRes['data'] = $objAPIProcessor->shipping($arrRequest);
                break;
            case 'getStock';
                $arrRes['data'] = $objAPIProcessor->getStock($arrRequest);
                break;
			case 'getpaypalUrl';
                $arrRes['data'] = $objAPIProcessor->getpaypalUrl($arrRequest);
                break;	
            case 'getAllCategories';
                $arrRes['data'] = $objAPIProcessor->getAllCategories($arrRequest);
                break;
