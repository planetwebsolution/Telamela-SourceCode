 ...
 *        	the offset within the string where we should start
 ...
 */
function tln_fixatts($tagname, $attary, $rm_attnames, $bad_attvals, $add_attr_to_tag, $trans_image_path, $block_external_images) {
	while ( list ( $attname, $attvalue ) = each ( $attary ) ) {
		/**
 ...
 *        	see description above
 * @param boolean $force_tag_closing
 *        	see description above
 * @param array $rm_attnames
 *        	see description above
 * @param array $bad_attvals
 ...
 */
function tln_sanitize($body, $tag_list, $rm_tags_with_content, $self_closing_tags, $force_tag_closing, $rm_attnames, $bad_attvals, $add_attr_to_tag, $trans_image_path, $block_external_images) {
	/**
