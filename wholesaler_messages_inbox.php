...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title><?php echo WHOL_INBOX_TITLE; ?></title>
        ...
        <style>.compose_message .compose_right{ width:695px; }</style>
    </head>
    <body>
        <em> <div id="navBar">
                        ...
                        <div class="add_edit_pakage compose_message">
                            <div class="compose_left_outer">
                                <ul class="compose_left">
                                    ...
                                    <li class="compose_active"><a style="color:#56a1f2" href="<?php echo $objCore->getUrl('wholesaler_messages_inbox.php', array('place' => 'inbox')); ?>"><?php echo INBOX; ?><small><img src="common/images/ref_icon.png" alt="" style=" margin-top:3px;position: absolute;"/></small> </a></li>
                                ...
                                <div class="compose_right scrollable">
                                  <!--  <h2><?php echo INBOX; ?></h2>-->
                                    <ul class="feebacks_sec">
                                        ...
                                        <?php
                                        if (count($objPage->arrInbox) > 0)
                                        {
                                            $varcounter = 0;
                                            $varPrevId = 0;
                                            foreach ($objPage->arrInbox as $var)
                                            {
                                                ...
                                                <li <?php echo $varcounter % 2 == 0 ? 'class="bg_color"' : '' ?>>
                                                    <span class="customer">
                                                        <?php
                                                        //echo ($var['fkParentID'] <> $varPrevId) ? $var['fkParentID'] : $var['fkParentID'] . '&nbsp;';
                                                        echo ($var['IsRead'] == '0') ? "<strong>" . $var['fkParentID'] . "</strong>" : $var['fkParentID'];
                                                        ?>
                                                    </span>
                                                    <span class="product">
                                                        <?php
                                                        echo ($var['FromUserType'] == 'admin') ? (($var['IsRead'] == '0') ? "<strong>  Admin  </strong>" : 'Admin') : (($var['IsRead'] == '0') ? "<strong>" . $var['FromName'] . "</strong>" : $var['FromName']);
                                                        ?>
                                                    </span>
                                                    <span class="read" >
                                                        <a  title="view message" href="<?php echo $objCore->getUrl('read_inbox_message.php', array('place' => 'readInbox', 'mgsid' => $var['pkSupportID'])); ?>">
                                                            <?php echo ($var['IsRead'] == '0') ? "<strong>" . $msgInbox . "</strong>" : $msgInbox; ?>
                                                        </a>
                                                    </span>
                                                    <span class="date">
                                                        <?php
                                                        echo ($var['IsRead'] == '0') ? "<strong>" . $objCore->localDateTime(date($var['SupportDateAdded']), DATE_TIME_FORMAT_SITE_FRONT_MINUTES) . "</strong>" : $objCore->localDateTime(date($var['SupportDateAdded']), DATE_TIME_FORMAT_SITE_FRONT_MINUTES);
                                                        ?></span>
                                                    <span class="action action2">
                                                        <a title="view message" href="<?php echo $objCore->getUrl('read_inbox_message.php', array('place' => 'readInbox', 'mgsid' => $var['pkSupportID'])); ?>"><i class="fa fa-eye" style="font-size:16px;
                                                                                                                                                                                                                line-height: 35px;
                                                                                                                                                                                                                color: #6db61f;"></i></a>
                                                        <a title="delete message" href="<?php echo $objCore->getUrl('read_inbox_message.php', array('place' => 'inbox', 'action' => 'delete', 'mgsid' => $var['pkSupportID'])); ?>" onclick="return confirm('<?php echo WANT_DELETE; ?>')"><i class="fa fa-trash-o" style="font-size: 16px; margin-left:10px;
                                                                                                                                                                                                                line-height: 35px;
                                                                                                                                                                                                                color: #7f7f7f;"></i></a>
                                                    </span>
                                                </li>
