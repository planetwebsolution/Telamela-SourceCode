...
<!--                            <li><a href="paypal_email_edit_uil.php?paypalid=<?php echo $_GET['paypalid']; ?>&type=edit">Edit Paypal Account</a></li>-->
                            <li><span>Edit Paypal Account</span></li>
                        </ul>
...
{ ?>
                                                            ...
                                                            <div class="span12 form-horizontal form-bordered box box-bordered box-color lightgrey">
                                                                ...
                                                                <div class="control-group">
                                                                    ...
                                                                    <div class="controls">
                                                                        ...
                                                                        if ($objPage->arrRow[0]['fkCountryID'] == $vCT['country_id'])
                                                                        {
                                                                            echo "selected";
                                                                        }
    ...
    <?php } ?>
                                                                ...
                                                                <div class="control-group">
                                                                    ...
                                                                    <div class="controls">
                                                                        <input type="text" name="frmEmail" id="frmEmail" size="30" value="<?php echo $objPage->arrRow[0]['EmailId']; ?>">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-actions">
                                                                    ...
                                                                    <input type="hidden" name="paypalId" value="<?php echo $objPage->arrRow[0]['pkPaypalID']; ?>" />
                                                                </div>
                                                            </div>
                                                        </div>
