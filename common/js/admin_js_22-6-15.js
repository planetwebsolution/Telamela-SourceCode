...
function validateUser(e){
    return validateForm(e,"frmTitle","User Title","R","frmFirstName","User Name","R","frmUserEmail","Email Address","RisEmail","frmPassword","Password","R","frmPassword","Password","isMin","frmConfirmPassword","Confirm Password","RisEqualfrmPassword:Password","frmAdminRoll","Role","R","frmCommission","Commission","R","frmSalesTarget","Sales Target","R")?!0:!1
}
...
function approveStatus(e,t,r){
    $.post("ajax.php",{
        ...
        window.location="wholesaler_manage_uil.php"
    })
}
