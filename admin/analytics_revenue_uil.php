	    ...
	    <?php require_once 'inc/reports_left_menu.php'; ?>
			...
			<div class="span12">
				...
				<div class="box-content nopadding">
					...
					<li>
					    <a href="#daily" data-toggle="tab" data-section="revenue" data-action="daily" data-container="#daily" class="tabAjaxChange">Daily</a>
					</li>
					<li>
					    <a href="#weekly" data-toggle='tab' data-section="revenue" data-action="weekly" data-container="#weekly" class="tabAjaxChange">Weekly</a>
					</li>
					<li>
					    <a href="#monthly" data-toggle='tab' data-section="revenue" data-action="monthly" data-container="#monthly" class="tabAjaxChange">Monthly</a>
					</li>		
				    </ul>
					...
					<div class="tab-pane" id="daily">
						...
						Total Revenue: <span class="totalCount">N/A</span>
					    </div>
					    <div class="statistic-big">
						<div class="bottom">
							<div class="flot medium" id="flot-audience-daily"></div>
						</div>
					    </div>
					</div>
					...
					<div class="tab-pane" id="weekly">
						...
						Total Revenue: <span class="totalCount">N/A</span>
				            ...
				            <div class="statistic-big">
						<div class="bottom">
							<div class="flot medium" id="flot-audience-weekly"></div>
						</div>
					    </div>
					</div>
					...
					<div class="tab-pane" id="monthly">
					    ...
					    <div class="statistic-big">
						<div class="bottom">
							<div class="flot medium" id="flot-audience-monthly"></div>
						</div>
					    </div>
					</div>
				    </div>
