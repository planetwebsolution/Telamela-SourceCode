                                        ...
                                        <div class="box box-color box-bordered">
                                            ...
                                            <div class="box-content nopadding">
                                                ...
                                                <?php if ($_SESSION['sessUserType'] == 'super-admin' || in_array('add-home-slider', $_SESSION['sessAdminPerMission'])) { ?>
                                                    <form action=""  method="post" id="frm_page" onsubmit="return validateFestivalPageForm(0);" enctype="multipart/form-data" > <div class="row-fluid">
                                                                ...
                                                                <div class="control-group">
                                                                    ...
                                                                    <div class="controls">
                                                                        ...
                                                                        <select name="frmCategoryId[]" id="frmCategoryId" multiple="" style="height: 200px;" class="input-large">
                                                                            ...
                                                                            <?php foreach ($objPage->arrCategoryDropDown[0] as $v) { ?>
                                                                                <option value="<?php echo $v['pkCategoryId']; ?>"><?php echo $v['CategoryName']; ?></option>
                                                                            <?php } ?>
                                                                        </select>
                                                                        <?php
                                                                        ?>&nbsp;
