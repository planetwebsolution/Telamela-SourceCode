<link type="text/css" rel="stylesheet" href="<?php echo JS_PATH; ?>jcrop/jquery.Jcrop.css" />
<?php /*
  <script type="text/javascript" src="<?php echo JS_PATH; ?>jcrop/jquedry.min.js"></script>
 */ ?>
...
<script type="text/javascript" src="<?php echo JS_PATH; ?>jcrop/jquery.Jcrop.js"></script>
<script type="text/javascript" src="<?php echo JS_PATH; ?>jcrop/main.Jcrop.js"></script>
<script type="text/javascript" src="<?php echo JS_PATH; ?>jcrop/upload_script.js"></script>