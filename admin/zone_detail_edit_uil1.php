                                            ...
                                            <div class="span12">
                                                <div class="box box-color box-bordered ">
                                                    <div class="nopadding">                                                            
                                                        ...
                                                        $j = 0;
                                                        $ZoneCountEdit = array();
//                                                        pre($objPage->zoneDetailListing);
                                                        if (!empty($objPage->zoneDetailListing)) {
                                                            ?>

                                                            <div class="control-group multiplezonebolck">
                                                                <!--                                                                <label for="textarea" class="control-label">*Zone:</label>-->

                                                                <input type="hidden" value="1" name="noOfZoneField" id="noOfZoneField" >
                                                                <?php
//                                                            pre($objPage->EditRows);
                                                                //foreach ($objPage->EditRows as $key => $val) {
                                                                //$j = $key;
                                                                ?>
                    ...
                    <!--                                                            <input type="hidden" name="title[<?php echo $j; ?>]" value="zone<?php echo $j + 1; ?>">-->
                                                                ...
                                                                <div class="controls1 controles_<?php echo $j; ?>  zone-country" style="padding: 20px ">
                                                                    ...
                                                                    <div class="DyZoneDiv_<?php echo $j; ?>" style="float:left;border:1px solid #ccc; width: 90%;text-align: center; position:relative;padding:10px">
                                                                        ...
                                                                        <h4 class="h4Edit" style="top:0; left:20px"><?php echo $objPage->zoneDetailListing[0]['title'] ?></h4>
                                                                        <?php
//                                                                            pre($objPage->zoneDetailListing);
                                                                        foreach ($objPage->zoneDetailListing as $k => $v) {
                                                                            //$valStr = str_replace('zone', '', $v['title']);
//                                                                                if (is_numeric($valStr)) {
//                                                                                    array_push($ZoneCountEdit, $valStr);
//                                                                                }
                                                                            // pre($val);
                                                                            // pre($v['fromstate']);
                                                                            $i = $k;
//                                                                                pre($v['id']);  
                                                                            ...
                                                                            <table  style="border: 1px solid #ccc;box-shadow: 0 0 6px #ccc; margin-bottom:10px; float: left;"class="table table-bordered dataTable-scroll-x" id="productRow">
...
//                                                                                            pre($abc);
                                                                                        ...
                                                                                        $SelectedCountryid = (!empty($v['fromcountry']) ? $v['fromcountry'] : '');
                                                                                        $selectedfromdistance = (!empty($v['fromdistance']) ? $v['fromdistance'] : '');
                                                                                        ...
                                                                                        echo $objGeneral->CountryNameLogistic($abc, 'fcountry[' . $j . '][]', $fcountry_id, $SelectedCountryid, 'Select Country', '', $html_entity, '1', '1');
                                                                                        ?>
        <!--                                                                                <input type="hidden" name="<?php echo $incrvar ?>" value="<?php echo $i ?>"/>-->
                                                                                        <!--<input type="hidden" name="title[<?php echo $j; ?>]" value="<?php // echo $v['title']  ?>">-->
                                                                                        <input type="hidden" name="zoneid" value="<?php echo $v['fkzoneid'] ?>">
                                                                                        <input type="hidden" name="detailzoneid[<?php echo $j; ?>][]" value="<?php echo $v['id'] ?>">
                                                                                    </td>
                                                                                    <?php //$frmcityid = 'frmcityid_' . $i;   ?>
                                                                                    <?php
                                                                                    $frmcityid = 'frmcityid_' . $j . '_' . $i;

                                                                                    $Selectedstateid = (!empty($v['fromstate']) ? $v['fromstate'] : '');
                                                                                    $statearraybycountryid = $objGeneral->statelistbycountryid($SelectedCountryid);
                                                                                    //pre($Selectedstateid);
                                                                                    ?>

                                                                                    <td>

                                                                                        <select name="fstate[<?php echo $j; ?>][]" onchange="showStateCity(this.value, 0, '<?php echo $frmcityid; ?>');"class='select2-me1 input-large statecheck' id="frmStateid_<?php echo $j . '_' . $i; ?>" >
                                                                                    ...
                                                                                    <td>
                                                                                        <?php
                                                                                        $Selectedcityid = (!empty($v['fromcity']) ? $v['fromcity'] : '');

                                                                                        $cityarraybystateid = $objGeneral->countrylistbynewstateid($Selectedstateid);
                                                                                        // pre($cityarraybystateid);
                                                                                        ?>
                                                                                    ...
                                                                                    <td><input type="text" name="frmdistance[<?php echo $j; ?>][]" id="<?php echo $frmdistance ?>" value="<?php echo $selectedfromdistance ?>" <?php echo (!$frmDistanceEnable) ? 'disabled' : ''; ?> placeholder="Distance +Km" ></td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        $SelectedtoCountryid = (!empty($v['tocountry']) ? $v['tocountry'] : '');
                                                                                        $selectedtodistance = (!empty($v['todistance']) ? $v['todistance'] : '');
                                                                                        ...
                                                                                        echo $objGeneral->CountryNameLogistic($abc, 'tcountry[' . $j . '][]', $tcountry_id, $SelectedtoCountryid, 'Select Country', '', $html_entity, '1', '1');
                                                                                        ?>
                                                                                    </td>
                                                                                    <?php
                                                                                    $tocityid = 'tocityid_' . $j . '_' . $i;
                                                                                    $Selectedtostateid = (!empty($v['tostate']) ? $v['tostate'] : '');
                                                                                    $statearraybycountryid = $objGeneral->statelistbycountryid($SelectedtoCountryid);
                                                                                    ?>
                                                                                    ...
                                                                                    <td>
                                                                                        <?php
                                                                                        $Selectedtocityid = (!empty($v['tocity']) ? $v['tocity'] : '');
                                                                                        $cityarraybystateid = $objGeneral->countrylistbynewstateid($Selectedtostateid);
                                                                                        ?>
                                                                                        <select name="tcity[<?php echo $j; ?>][]"  id="tocityid_<?php echo $j . '_' . $i; ?>" minusI = "<?php echo $i; ?>" minusJ = "<?php echo $j; ?>" class='select2-me1 input-large  citycheckto'>
                                                                                            ...
                                                                                            foreach ($cityarraybystateid as $vv) {
                                                                                                ...
                                                                                                //in_array($gatway,)
                                                                                                if ($Selectedtocityid == $vv['id']) {
                                                                                                    $toDistanceEnable = true;
                                                                                                    echo '<option selected value=' . $vv['id'] . '>' . $vv['name'] . '</option>';
                                                                                                } else {
                                                                                                    echo '<option value=' . $vv['id'] . '>' . $vv['name'] . '</option>';
                                                                                                }
                                                                                    ...
                                                                                    <td><input type="text" name="todistance[<?php echo $j; ?>][]" id="todistance_<?php echo $j . '_' . $i; ?>" value="<?php echo $selectedtodistance ?>" <?php echo (!$toDistanceEnable) ? 'disabled' : ''; ?> placeholder="Distance +Km" ></td>
                                                                            ...
                                                                            <?php if ($k != 0) { ?>
                                                                                <div style="float:left;margin-left: -22px;display: inline-block;position: relative;left: 64px;" class="PlusMinus_<?php echo $j . '_' . $i; ?>"  >
                                                                                    <i><span valueofi="1" valueofj="0" style="cursor: pointer;width:51px;" title="Delete section" class="minuseditRemove" minusI = "<?php echo $i; ?>" minusJ = "<?php echo $j; ?>" id = "<?php echo $v['id']; ?>"><img class="" src="../admin/images/minus.png"></span></i>
                                                                                </div>

                                                                                <?php
                                                                            }
                                                                            $frmDistanceEnable = false;
                                                                            $toDistanceEnable = false;
                                                                        }
                                                                        ?>
    ...
    <!--                                                                            <i><span valueOfJ="<?php echo $j; ?>" valueOfI="<?php echo $i; ?>" zoneid="<?php echo $v['pkzoneid']; ?>"style="cursor: pointer;width:51px;" title="Delete Complete zone" class="zoneeditRemove"><img src="../admin/images/minus.png"/></span></i>-->
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="form-actions formactionleft">                        
                                                                ...
                                                                <?php /* <button  valueOfJ="<?php echo $j; ?>"name="newzone" type="button" value="addnewzone" class="btn addnewzonebolck" >Add A New Zone</button>
                                                                 */ ?>
                                                                <input type="hidden" name="frmHidenZoneEdit" id="frmHidenEdit" value="editzones" />
