 ...
 */
class logisticOrder extends Database {
    ...
    function orderList($argWhere = '', $argLimit = '') {
        ...
        $varQuery = "SELECT oi.fkOrderID,oi.Quantity, oi.fkMethodID,oi.ShippingPrice,o.ShippingCountry,oi.pkOrderItemID,oi.transaction_ID, oi.SubOrderID, group_concat(oi.ItemName) as Items,concat(o.CustomerFirstName,' 
