...
//                                                                     pre($val);
                                                                    ...
                                                                    <td class="hidden-480">
                                                                        ...
                                                                        <a class="btn" href="zone_listing_uil.php?type=listingzones&LogisticId=<?php echo $val['logisticportalid']; ?>&countryId=<?php echo $val['logisticportal']; ?>" rel="tooltip" title="" data-original-title="View all zones">
