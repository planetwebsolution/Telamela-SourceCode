                ...
                <div class="container-fluid">
                    ...
                    <div class="row-fluid">
                        <div class="span12 margin_top20">
                            <div class="fleft"> <a href="zone_price_add_uil.php?type=add&LogisticId=<?php echo $objPage->logisticId; ?>">
                            ...
                            <div class="box box-color box-bordered" >
                                ...
                                <div class="box-content nopadding manage_categories">
                                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
                                        <?php if (!empty($objPage->zonePriceList)) { ?>
                                            <form id="frmUsersList" name="frmUsersList" action="coupon_action.php" method="post">
                                                <table class="table table-hover table-nomargin table-bordered usertable">
                                                    ...
                                                    <tbody>
                                                        <?php
//                                                        pre($objPage->logisticId);
                                                        $i = 1;
                                                        foreach ($objPage->zonePriceList as $val) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="hidden-480">
                                                                    ...
                                                                    ?></td>
                                                                <td>
                                                                    <a class="btn" rel="tooltip" title="Edit" href="zone_price_edit_uil.php?type=edit&id=<?php echo $val['pkpriceid']; ?>&LogisticId=<?php echo $objPage->logisticId; ?>">
                                                                        <i class="icon-edit"></i>
                                                                    </a> 
