...
<html>
    <head>
        ...
        <title><?php echo ADMIN_PANEL_NAME; ?> : Wholesaler support enquiry</title>
            ...
            <div id="main">
                <div class="container-fluid">
                    <div class="page-header">
                        <div class="pull-left">
                            <h1>Wholesaler Support Inbox</h1>
                        </div>
                    ...
                    <div class="breadcrumbs">
                        <ul>
                            ...
                            <li>
                                <span>Wholesaler Support Inbox</span>
<!--                                <i class="icon-angle-right"></i>-->
                            </li>
                    ...
                    <div class="row-fluid">
                        ...
                        if ($objCore->displaySessMsg()) {
                                ?>
                                    ...
                                    <tr>
                                        <!--<td colspan="2" valign="top" class="success" style="padding:8px 0 8px 0;border:#B4B4B4 4px solid; background-color:#F0F0F0;">-->
											<td colspan="2" valign="top" class="success" style="padding:8px 0 8px 0;">
                                            <?php
                                    ...
                                    <div class="box-content nopadding manage_categories">
                                        <form id="frmUserEnquiryList" name="frmUserEnquiryList" action="wholesaler_support_enquiry_action.php" method="post">
                                            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
                                                    ...
                                                    if ($val['IsRead'] == '0') {
                                                        ...
                                                        echo $msgInbox;
                                                                ...
                                                                ?></td>
                                                                    ...
                                                                    <td class="hidden-480"><?php echo $objCore->localDateTime($val['SupportDateAdded'], DATE_TIME_FORMAT_SITE); ?></td>


                                                                    <td>
                                                                        <a href="wholesaler_support_enquiry_view_uil.php?id=<?php echo $val['pkSupportID']; ?>&type=edit" class="btn" rel="tooltip" title="" data-original-title="View"><i class="icon-eye-open"></i></a>
                                                ...
                                                <input type="hidden" name="frmChangeAction" value="Delete All"/>
