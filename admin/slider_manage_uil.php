    ...
    <head>
        ...
        <script type="text/javascript">
            function changeStatus(status,bid){
                ...
                $.post("ajax.php",{action:'ChangeHomeBannerStatus',status:status,bid:bid},
                function(data)
                {
                    $(showid).html(data);
                });
                    ...
                    <?php if ($_SESSION['sessUserType'] == 'super-admin' || in_array('listing-home-slider', $_SESSION['sessAdminPerMission'])) { ?>
                        <div class="breadcrumbs">
                            <ul>
                                ...
                                <li><span>Manage Home Banner</span></li>
                            </ul>
                        ...
                        <div class="row-fluid">
                            <div class="span12 margin_top20">
                                <div class="fleft">
                                    ...
                                    <a href="slider_add_uil.php?type=add"><button class="btn btn-inverse">Create New</button></a>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="row-fluid">
                                                ...
                                                <div class="row-fluid">
                                                    <div class="form-actions span12 search">
                                                        ...
                                                        <a <?php if (isset($_GET['frmSearchPressed'])) { ?> href="slider_manage_uil.php" <?php } else { ?>onclick="showSearchBox('search','hide');" <?php } ?>><input type="button" value="<?php echo ADMIN_SEARCH_CANCEL_BUTTON; ?>" class="btn" /></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                                                ...
                                                <form id="frmHomeBanner" name="frmHomeBanner" action="" method="post">
                                                    <table class="table table-hover table-nomargin table-bordered usertable">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class='hidden-480'>Festival</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach ($objPage->arrRows as $val) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="hidden-480"><?php echo $varCountry; ?></td>                                                                    
                                                                ...
                                                                echo '<span  class="label label label-lightred">Deactive</span>';
                                                                    ...
                                                                    <td>
                                                                        <a class="btn" data-original-title="Edit" rel="tooltip" title="" href="slider_edit_uil.php?id=<?php echo $val['pkBannerID']; ?>&type=edit"><i class="icon-edit"></i></a>
                                                                        <a class='btn' data-original-title="Delete" rel="tooltip" title="" href="slider_action.php?frmID=<?php echo $val['pkBannerID']; ?>&frmChangeAction=Delete&deleteType=sD" onClick='return fconfirm("Are you sure you want to delete this banner ?",this.href);'><i class="icon-remove"></i></a>
                                                                    </td>
                                                                </tr>
                                                                <?php
                                                            }
                                                    ...
                                                    if ($objPage->varNumberPages > 1) {
                                                        $objPage->displayPaging($_GET['page'], $objPage->varNumberPages, $objPage->varPageLimit);
                                                            ...
                                                            ?></div>
                                                    <div class="controls hidden-480" style="margin: 10px">
