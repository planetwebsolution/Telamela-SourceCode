...
require_once CONTROLLERS_ADMIN_PATH . FILENAME_ZONE_PRICE_ADMIN_CTRL;
//pre($objPage->arrRow);
?>
<!doctype html>
<html>
                ...
                <div class="container-fluid">
                    ...
                    <div class="breadcrumbs">
                        <ul>
                            ...
                            <li>
                                <a href="zone_price_manage_uil.php">Price</a>
                                <i class="icon-angle-right"></i>
                            </li>
...
//                                                                                        echo $objGeneral->shippingmethodlisthtml($shippingmethodarray, 'shippingmethod[]', 'shippingmethodid', $SelectedMethod, 'Select Shipping Method', 0, 'class="select2-me1 input-xlarge" ', 1, 0, 1);
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td> <input type="number" name="length[]" min="0"value="<?php echo $objPage->arrRow['detailById'][0]['maxlength']; ?>" placeholder="cm"/></td>
                                                                                    <td> <input type="number" name="width[]" min="0"value="<?php echo $objPage->arrRow['detailById'][0]['maxwidth']; ?>" placeholder="cm"/></td>
                                                                                    <td> <input type="number" name="height[]" min="0"value="<?php echo $objPage->arrRow['detailById'][0]['maxheight']; ?>" placeholder="cm"/></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td> *Weight(kg)</td>
                                                                                    <td> <input type="number" name="minweight[]" min="0"value="<?php echo $objPage->arrRow['detailById'][0]['minkg']; ?>" placeholder="Min (kg)"/></td>
                                                                                    <td> <input type="number" name="maxweight[]" min="0"value="<?php echo $objPage->arrRow['detailById'][0]['maxkg']; ?>" placeholder="Max (kg)"/></td>
                                                                                    <td>&nbsp;</td>
                                                                                </tr>

                                                                                <tr>
                                                                                    <td> *Cost Per Kg</td>
                                                                                    <td> <input type="number" name="cost[]" min="0" value="<?php echo $objPage->arrRow['detailById'][0]['costperkg']; ?>" placeholder="cost"/></td>
                                                                                    <td>&nbsp;</td>
                                                                                    <td>&nbsp;</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td> Handling cost ($) per item</td>
                                                                                    <td> <input type="number" name="handlingcost[]" min="0"value="<?php echo $objPage->arrRow['detailById'][0]['handlingcost']; ?>" placeholder="handlingcost"/></td>
                                                                                    <td>&nbsp;</td>
                                                                                    <td>&nbsp;</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td> Fragile Handling cost ($)</td>
                                                                                    <td> <input type="number" name="fragilecost[]" min="0"value="<?php echo $objPage->arrRow['detailById'][0]['fragilecost']; ?>" placeholder="fragilecost"/></td>
                                                                                    <td>&nbsp;</td>
                                                                                    <td>&nbsp;</td>
                                                                                </tr>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td> <input type="number" name="cubic[]" min="0"value="<?php echo $objPage->arrRow['detailById'][0]['cubicweight']; ?>" placeholder="cubicweight"/></td>
                                                                                    <td>&nbsp;</td>
                                                                                    <td>&nbsp;</td>
                                                                                </tr>
                                                                            </table>
                                                                ...
                                                                <div class="form-actions formactionleft">     
                                                                    ...
                                                                    <input type="hidden" value="<?php echo $objPage->arrRow['detailById'][0]['pkpriceid']; ?>" name="prepriceid" >
                                                                    <input type="hidden" value="1" name="pricestatus" >
                                                                    <input type="hidden" value="<?php echo $objPage->logisticId; ?>" name="logisticId" >
