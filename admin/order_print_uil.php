...
<html>
    <head>
        ...
        <link href="<?php echo CSS_PATH; ?>print.css" rel="stylesheet" type="text/css" media="print"  />
                ...
                <div class="container-fluid">
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <?php if ($_SESSION['sessUserType'] == 'super-admin' || in_array('listing-orders', $_SESSION['sessAdminPerMission'])) { ?>
                                            ...
                                            <div class="box-title">
                                                <?php if ($varNum > 0) { ?>
                                                    ...
                                                    <a href="javascript:void(0)" onclick="window.print();">
                                                        <input class="btn" type="button" style="float:right; margin:6px 2px 0 0; width:107px;" value="Print" />
                                                    </a>
                                                <?php } ?>


                                                <a id="buttonDecoration" href="javascript:void(0)" onclick="window.close();"><input type="button" class="btn" name="btnTagSettings" value="Close" style="float:right; margin:6px 2px 0 0; width:107px;"/></a>
