    ...
    <div id="owl-demo" class="owl-carousel owl_main" style="/*height:510px;*/ position:relative">
        ...
        <div class="banner_block">
            <div class="ad">
                ...
                {
                    ?>
                    <a href="<?php echo $objPage->arrData['arrAdsDetails'][0]['AdUrl'] ?>" target="_blank"><img src="<?php echo UPLOADED_FILES_URL; ?>images/ads/189x207/<?php echo $objPage->arrData['arrAdsDetails'][0]['ImageName'] ?>" alt="<?php echo $objPage->arrData['arrAdsDetails'][0]['Title'] ?>" border="0" title="<?php echo $objPage->arrData['arrAdsDetails'][0]['Title'] ?>"  /></a>
                    <?php
                }
                else
                {
