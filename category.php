...
//pre($_GET['name']);
$titlename = explode("/", $_GET['name']);
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
<!--         <title><?php echo!empty($titlename[1]) ? $titlename[1] : CATEGORY_TITLE; ?></title>-->
        ...
        <style>
            ...
            /*.toggle .scroll-pane .jspPane{position: static !important;}*//*27-7-15D*/
                ...
                if (count($objPage->arrProductDetails) > 0) {
                    ...
                    <div>
                        ...
                        <div class="parent_child_left">
                            <?php
                            //pre(count($objPage->CategoryChildList));
                                ...
                                <div class="category_list">
                                    ...
                                    <div class="toggle">
                                        <div class="category_left">
                                            <div class="main_left">
                                                <div class="listing_1">
                                                    <a href="<?php echo $objCore->getUrl('category.php', array('cid' => $objPage->parentDetailsCategory[0]['CategoryParentId'], 'name' => $objPage->parentDetailsCategory[0]['CategoryParentName'])); ?>" class="active_lisitng_category">
                                                        All <?php echo $objPage->parentDetailsCategory[0]['CategoryParentName']; ?>
                                                    </a>
                                                    <ul class="parent_check">
                                                        <li><label><?php echo $_GET['name']; ?></label></li>
        <!--                                                          <li><label><?php echo $titlename[1]; ?></label></li>-->
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="scroll-pane category_left">
                                                    <ul class="parent_check"   style="padding-bottom:2px;">
                                                        ...
                                                        foreach ($objPage->arrWholeSalerList as $wholeSalerList) {
                                                            ...
                                                            ?>
                                                            <li>
                                                                <input type="checkbox" class="whl stsyled" id="frmCategoryWholeSalerId<?php echo $cnt + 1; ?>" name="frmCategoryWholeSaler[]" value="<?php echo ucfirst($wholeSalerList['pkWholesalerID']); ?>" autocomplete="off" />
                ...
                <!--                                                            <input type="button" value="Search"/>-->
                                                    ...
                                                    <div class="scroll-pane category_left">
                                                        ...
                                                        ?>
                                                        <li>
                                                            <input type="checkbox" class="Attribute styleda"  name="frmAttribute_<?php echo $valAttributeDetail['pkAttributeId']; ?>" value="<?php echo $valAttributeDetail['pkOptionID']; ?>" autocomplete="off"/>
                                ...
                                <?php
                                //pre($objPage->arrData['arrAdsDetails']);
...
<!--                                                <img class="idpico" idp="twitter" src="<?php echo IMAGE_FRONT_PATH_URL; ?>socialicons/twitter.png" title="twitter" />-->
        ...
        <div class="no_style"style="width:1140px;margin:0 auto;"><br style="clear:both" />
            <?php
            $totalPageCount = 0;
            if (count($objPage->arrData['arrMonthPremium']) > 0) {
                ?>
                <div class="no_style" style="margin-left:180px;width:780px;">
