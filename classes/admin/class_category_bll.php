...
//            $categoryLevel = $arrRes[0]['CategoryLevel'] + 1;
        ...
        if ($varCategoryNum == 0) {
            ...
            $argWhere = "CategoryOrdering ='" . $valOrder . "'and CategoryLevel='" . $category_level . "'" . "and CategoryParentId='" . $argPost['CategoryParentId'] [$key] . "'";
            // $argWhere1 = "CategoryOrdering ='" . $arrPost['frmCategoryOrdering'] . "'";
            $argWhere1 = "CategoryOrdering ='" . $arrPost['frmCategoryOrdering'] . "'and CategoryLevel='" . $categoryLevel . "'" . "and CategoryParentId='" . $arrPost['frmParentId'] . "'";
            ...
            if (count($arrRes) == 0) {
                ...
                if ($arrAddID) {
                    $varCategoryImageUrl = $varCategoryIconUrl = '';
                    ...
                    if ($categoryLevel == 1) {
                        ...
                        $varCategoryIconUrl = SITE_ROOT_URL . 'common/uploaded_files/images/category/main_category2/icons/';
                        $varDirLocation = UPLOADED_FILES_SOURCE_PATH . 'images/category/main_category2/';
                        $varDirLocationIcons = UPLOADED_FILES_SOURCE_PATH . 'images/category/main_category2/icons/';
                    } else if ($categoryLevel == 0) {
                        $varCategoryImageUrl = SITE_ROOT_URL . 'common/uploaded_files/images/category/main_category1/';
                        $varCategoryIconUrl = SITE_ROOT_URL . 'common/uploaded_files/images/category/main_category1/icons/';
                        $varDirLocation = UPLOADED_FILES_SOURCE_PATH . 'images/category/main_category1/';
                        $varDirLocationIcons = UPLOADED_FILES_SOURCE_PATH . 'images/category/main_category1/icons/';
                    }
                    ...
                    if (!empty($arrFiles['frmCategoryIcon']['name'])) {
                        $varCategoryIcons = $this->imageUpload($arrFiles['frmCategoryIcon'], $_GET['type'], $_GET['cid'], $varDirLocationIcons, $categoryLevel);
                    }
...
//                        'fkCategoryId' => $_GET['cid'],
                            ...
                            'categoryIconUrl' => $varCategoryIconUrl,
                            'categoryImage' => $varCategoryImage,
                            'categoryIconImage' => $varCategoryIcons,
    ...
    function editCategory($argCategoryID) {
        ...
        $arrClms = array('pkCategoryId,categoryImage,categoryImageUrl,categoryIconImage,categoryIconUrl,cat.CategoryName', 'CategoryDescription', 'CategoryParentId', 'CategoryOrdering', 'CategoryMetaTitle', 'CategoryMetaKeywords', 'CategoryMetaDescription', 'CategoryHierarchy');
...
//                     }
// //                pre($varCategoryImageUrl);
//                     $arrImagesClms = $arrImagesClmsIcons = array();
//                     if (!empty($varCategoryImageUrl) && isset($varCategoryImage)) {
//                         $arrImagesClms = array(
//                             'fkCategoryId' => $_GET['cid'],
//                             'categoryName' => $arrPost['frmName'],
...
//                         );
//                     }
//                     if ((!empty($varCategoryIconUrl) && isset($varCategoryIcons))) {
//                         $arrImagesClmsIcons = array(
//                             'fkCategoryId' => $_GET['cid'],
//                             'categoryName' => $arrPost['frmName'],
//                             'categoryIconImage' => $varCategoryIcons,
//                             'categoryIconUrl' => $varCategoryIconUrl,
...
//                         );
//                     }
//                     $arrImagesClms = array_merge($arrImagesClmsIcons, $arrImagesClms);
//                     if (!empty($arrImagesClms)) {
//                         //Check for image existance.                    
//                         $varCheckExistImage = $this->select(TABLE_CATEGORY_IMAGES, array('pkCategoryImageId'), $varWhrImage);
//                         if (count($varCheckExistImage) > 0)
//                             $this->update(TABLE_CATEGORY_IMAGES, $arrImagesClms, $varWhrImage);
...
// //        //$argWhere1 = "CategoryOrdering ='" . $arrPost['frmCategoryOrdering'] . "'";
// //        $argWhere1 = "CategoryOrdering ='" . $arrPost['frmCategoryOrdering'] .  "'and CategoryLevel='".$categoryLevel."'". "and CategoryParentId='".$arrPost['frmParentId']."'";
// //        $arrRes = $this->select($varTable, $arrClms1, $argWhere1,'','','',true);
//                 //pre($arrRes);
// //        if (empty($arrRes)) {
// //             $arrUpdateID = $this->update(TABLE_CATEGORY, $arrClms, $varWhr);
// //            //Check that successfully updated or not
...
//                {
                $varWheree = "CategoryParentId = '" . $argPost['CategoryParentId'] [$key] . "' ";
                $arrCategoryRow = $this->select(TABLE_CATEGORY, array('CategoryLevel'), $varWheree);
                //pre($arrCategoryRow[0]);

                $category_level = $arrCategoryRow[0]['CategoryLevel'];
                // pre($category_level);
//                }
//                else
//                {
