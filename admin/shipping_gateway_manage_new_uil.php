                        ...
                        <div class="row-fluid">
                            <div class="span12 margin_top20">
                                <div style="float:left">
                                    <a href="shipping_price_add_new_uil.php?type=add"><button class="btn btn-inverse">Add New</button></a>
                                </div>
                                    ...
                                    <div class="box-content nopadding manage_categories">  
                                        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
                                            <?php if ($objPage->NumberofRows > 0) { ?>
                                                <form id="frmPackageList" name="frmPackageList" action="shipping_price_new_action.php" method="post">  
                                                    ...
                                                    <table class="table table-hover table-nomargin table-bordered usertable">
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="hidden-480">Countries Portal</th>
                                                                <th>Shipping Gateway</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach ($objPage->arrRows as $val) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $val['AdminUserName'] . ' (' . $val['AdminEmail'] . ')'; ?></td>
                                                                    <td class="hidden-480"><?php echo $val['ShippingTitle']; ?></td>                                                                   
                                                                    <td class="hidden-480"><?php echo $val['countryName']; ?></td>                                                                   
...
<!--                                                                    <td class='hidden-480'>
                                                                    ...
                                                                    <td>	
                                                                        <a class="btn" rel="tooltip" title="Edit" href="shipping_gateway_edit_new_uil.php?sgid=<?php echo $val['fkShippingGatewaysID']; ?>&smid=<?php echo $val['pkAdminID']; ?>&prid=<?php echo $val['pkShippingPriceID']; ?>&type=edit"><i class="icon-edit"></i></a>                                        
                                                                        <a class='btn' rel="tooltip" title="Delete" href="shipping_gateway_new_action.php?frmID=<?php echo $val['fkShippingGatewaysID']; ?>&PortalID=<?php echo $val['pkAdminID']; ?>&shipName=<?php echo $val['ShippingTitle']; ?>&frmChangeAction=Delete&deleteType=sD" onClick="return fconfirm('Are you sure you want to delete this packages ?', this.href)"><i class="icon-remove"></i></a>
                                                                    </td>
                                                                </tr>
                                                                <?php
                                                                $i++;
