    ...
    private function getList() {
        ...
        if (isset($_REQUEST['frmSearchPressed']) && $_REQUEST['frmSearchPressed'] == 'Yes') {
           ...
           // echo "avi";die;
            ...
            $varWhereClause .= " AND oi.Status in('Pending','Posted','Completed','Canceled','Processing','Processed','Shipped','Delivered') AND oi.DisputedStatus in('noDisputed','Resolved') " . $varPortalFilter;
            //die;
