...
require_once CONTROLLERS_ADMIN_PATH . FILENAME_INVOICE_CTRL;
                    ...
                    if ($_SESSION['sessUserType'] == 'super-admin' || in_array('listing-invoices', $_SESSION['sessAdminPerMission'])) {
                        ...
                        <div class="breadcrumbs">
                            <ul>
                                ...
                                <li><span>Manage Invoices</span></li>
                            </ul>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach ($objPage->arrRows as $val) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo ADMIN_CURRENCY_SYMBOL . $objCore->price_format($val['Amount']); ?> </td>
                                                                    <td>
                                                                        <?php
