...
<html>
    <head>
        ...
        <title><?php echo ADMIN_PANEL_NAME; ?> : Category Add</title>
            ...
            function callCatChange(refer) {
                ...
                $.post('<?php echo SITE_ROOT_URL; ?>admin/ajax.php', str, function (response) {
                    if (response)
                    {
                        ...
                        $('#frmName').attr('onblur', 'checkExists(this.value,"",' + response.parentId + ',' + response.lavel + ')');
                    }
                }, "json");
            }
...
<?php if (isset($_GET['pcid'])) { ?>
                var tre = '1';

                $('#findCategoryLavel').val(tre);
                                    ...
                                    <div class="span12">
                                        <div class="box box-color box-bordered">
                                            ...
                                            <div class="box-content nopadding">
                                                ...
                                                <?php
                                                if ($_SESSION['sessUserType'] == 'super-admin' || in_array('add-categories', $_SESSION['sessAdminPerMission'])) {
                                                    ?>
                                                    <form action="" method="post" id="frm_page" enctype="multipart/form-data" onsubmit="return validateCategoryAddEditForm(0);" >

                                                        <input type="hidden" name="findCategoryLavel" id="findCategoryLavel" value="<?php
                                                            ...
                                                            <div class="span12 form-horizontal form-bordered box box-bordered box-color lightgrey">
                                                                ...
                                                                <div class="control-group">
                                                                    ...
                                                                    <div class="controls">
                                                                        ...
                                                                        ?>
                                                                        <input type="text" name="frmName" id="frmName" value="<?php echo $objPage->arrRow[0]['CategoryName']; ?>" class="input-xlarge" maxlength="50"  onBlur="checkExists(this.value, '',<?php echo $_GET['pcid'] ?>, 0)"/>
                                                                ...
                                                                <div class="control-group">
                                                                    ...
                                                                    <div class="controls">
                                                                        <?php
                                                                        $pid = (isset($objPage->arrRow[0]['CategoryParentId'])) ? $objPage->arrRow[0]['CategoryParentId'] : (int) $_GET['pcid'];
                                                                        echo $objGeneral->CategoryHtml($objPage->arrCategoryDropDown, 'frmParentId', 'frmParentId', array($pid), 'Root Category', 0, 'class="select2-me input-xlarge" onchange="callCatChange(this)"', 1, 0, 'fromCategory');
                                                                        ?>
                                                                    </div>
                                                                </div>
                                                                <div class="control-group">
                                                                ...
                                                                <div class="control-group">
                                                                    ...
                                                                    <div class="controls">
                                                                        ...
                                                                        &nbsp;&nbsp;<span class="req" id="bannerMsgIcon">Category Icon size <?php echo $mainCategoryIconSize; ?> px </span>
                                                                    </div>
                                                                </div>
                                                                <div class="control-group">
                                                                    <label for="textfield" class="control-label">Description: <br /><span class="req">Max 100 character</span></label>
                                                                    <div class="controls">
                                                                        <textarea name="frmCategoryDescription" id="frmCategoryDescription" class="input-block-level" maxlength="100" rows="4"><?php echo $objPage->arrRow[0]['CategoryDescription']; ?></textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="control-group">
