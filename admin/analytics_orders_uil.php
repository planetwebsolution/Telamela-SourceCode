	    ...
	    <?php require_once 'inc/reports_left_menu.php'; ?>
			...
			<div class="span12">
				...
				<div class="box-content nopadding">
					...
					<li>
					    <a href="#today" data-toggle="tab" data-section="orders" data-action="today" data-container="#today" class="tabAjaxChange">Today</a>
					</li>
					<li>
					    <a href="#yesterday" data-toggle='tab' data-section="orders" data-action="yesterday" data-container="#yesterday" class="tabAjaxChange">Yesterday</a>
					</li>
					<li>
					    <a href="#last_week" data-toggle='tab' data-section="orders" data-action="last_week" data-container="#last_week" class="tabAjaxChange">Last week</a>
					</li>
					<li>
					    <a href="#last_month" data-toggle='tab' data-section="orders" data-action="last_month" data-container="#last_month" class="tabAjaxChange">Last Month</a>
					</li>
					<li>
					    <a href="#top_order" data-toggle='tab' data-section="orders" data-action="top_order" data-container="#top_order" class="tabAjaxChange">Top Orders</a>
					</li>					
				    </ul>
					...
					<div class="tab-pane" id="today">
						...
						<div id="datesDiv">
						    Date(s): <span class="dateContainer">N/A</span>
						</div>
						<div id="countersDiv">
						    Total Orders: <span class="totalCount">N/A</span>
						</div>
					    </div>
					...
					<div class="tab-pane" id="top_order">
					    <div class="statistic-big">
						<div id="orderTopContainer" class='orderTopContainer'></div>
					    </div>
					</div>
