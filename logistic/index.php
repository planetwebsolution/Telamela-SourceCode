...
//pre($_SESSION);
if ($_SESSION['sessLogistictype'] > 0) {
    ...
    <body class='login' onload="document.getElementById('frmAdminUserName').focus();">
        <div class="wrapper">            
            ...
            <div class="login-body">
                ...
                <h2>SIGN IN</h2>
                <form action="logistic_login_action.php" method="post" name="frm_login" id="frm_login" onsubmit="return validateAdminLogin('frm_login');" class="form-validate">
