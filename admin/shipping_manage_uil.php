                        ...
                        <div class="row-fluid">
                            <div class="span12 margin_top20">
                                <div style="float:left">
                                    <a href="shipping_add_uil.php?type=add"><button class="btn btn-inverse">Add New Shipping Gateway</button></a>
                                </div>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php if ($val['ShippingType'] == 'admin') { ?>
                                                                            <a class="btn" rel="tooltip" title="Edit" href="shipping_edit_uil.php?smid=<?php echo $val['pkShippingGatewaysID']; ?>&type=edit"><i class="icon-edit"></i></a>
                                                                            <?php if ($val['noOfMethods'] == 0) { ?>
                                                                                <a class='btn' rel="tooltip" title="Delete" href="shipping_action.php?frmID=<?php echo $val['pkShippingGatewaysID']; ?>&shipName=<?php echo $val['ShippingTitle']; ?>&frmChangeAction=Delete&deleteType=sD" onClick="return fconfirm('Are you sure you want to delete this shipping gateway?',this.href)"><i class="icon-remove"></i></a>
                                                                            <?php } else { ?>
