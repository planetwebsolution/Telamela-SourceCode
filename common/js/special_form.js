...
jQuery(document).ready(function(){
    ...
    $('.more_fest').click(function(e){
        ...
        str +='<br/><br/><br/><div class="special_remove_event"><a href="#" class="delete_icon3 remove_event" title="Remove event"></a></div><div class="cat"><ul><li>'+catHtml+'</li></ul><a class="more more_cat" href="#" row="'+rowNum+'"><small>Add more category</small> +</a></div>';
        str +='</li>';
