...
<html>
    <head>
        ...
        <title><?php echo ADMIN_PANEL_NAME; ?> : Edit-Zone</title>
...
//                                                                            pre($val);
                                                                            foreach ($val as $k => $v) {
                                                                               ...
                                                                               // pre($val[$k]['fromstate']);
                                                                                ...
                                                                                ?>    
                                                                                <?php if ($k == 0) { ?>
                                                                                    <h4 class="h4Edit" style="top:0; left:20px"><?php echo $v['title'] ?></h4>
                                                                                <?php } ?>
                                                                                <table  style="border: 1px solid #ccc;box-shadow: 0 0 6px #ccc; margin-bottom:10px; float: left;"class="table table-bordered dataTable-scroll-x" id="productRow">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            ...
                                                                                            $SelectedCountryid = (!empty($val[$k]['fromcountry']) ? $val[$k]['fromcountry'] : '');
                                                                                            $selectedfromdistance = (!empty($val[$k]['fromdistance']) ? $val[$k]['fromdistance'] : '');
            ...
            <!--                                                                                <input type="hidden" name="<?php echo $incrvar ?>" value="<?php echo $i ?>"/>-->
                                                                                            ...
                                                                                            <input type="hidden" name="zoneid[<?php echo $j; ?>]" value="<?php echo $v['fkzoneid'] ?>">
                                                                                            <input type="hidden" name="detailzoneid[<?php echo $j; ?>][]" value="<?php echo $val[$k]['id'] ?>">
                                                                                        </td>
                                                                                        <?php //$frmcityid = 'frmcityid_' . $i;  ?>
                                                                                        <?php
                                                                                        $frmcityid = 'frmcityid_' . $j . '_' . $i;
                                                                                        
                                                                                        $Selectedstateid = (!empty($val[$k]['fromstate']) ? $val[$k]['fromstate'] : '');
                                                                                        ...
                                                                                        <td>
                                                                                            <?php
                                                                                            $Selectedcityid = (!empty($val[$k]['fromcity']) ? $val[$k]['fromcity'] : '');
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            ...
                                                                                            $SelectedtoCountryid = (!empty($val[$k]['tocountry']) ? $val[$k]['tocountry'] : '');
                                                                                            $selectedtodistance = (!empty($val[$k]['todistance']) ? $val[$k]['todistance'] : '');
                                                                                        ...
                                                                                        $Selectedtostateid = (!empty($val[$k]['tostate']) ? $val[$k]['tostate'] : '');
                                                                                        ...
                                                                                        <td>
                                                                                            <?php
                                                                                            $Selectedtocityid = (!empty($val[$k]['tocity']) ? $val[$k]['tocity'] : '');
                                                                                ...
                                                                                <?php if ($k != 0) { ?>
                                                                                    <div style="float:left;margin-left: -22px;display: inline-block;position: relative;left: 64px;" class="PlusMinus_<?php echo $j . '_' . $i; ?>"  >
                                                                                        <i><span valueofi="1" valueofj="0" style="cursor: pointer;width:51px;" title="Delete section" class="minuseditRemove" minusI = "<?php echo $i; ?>" minusJ = "<?php echo $j; ?>" id = "<?php echo $val[$k]['id']; ?>"><img class="" src="../admin/images/minus.png"></span></i>
                                                                                    </div>
        ...
        <!--                                                                            <i><span valueOfJ="<?php echo $j; ?>" valueOfI="<?php echo $i; ?>" zoneid="<?php echo $val[$k]['pkzoneid']; ?>"style="cursor: pointer;width:51px;" title="Delete Complete zone" class="zoneeditRemove"><img src="../admin/images/minus.png"/></span></i>-->
                                                                        </div>
                                                                    </div>
