...
class SupportCtrl extends Paging {
	...
	$this->varPageStart = $objPaging->getPageStartLimit($varPage, $this->varPageLimit);
        ...
        $arrRecords = $objSupport->viewAllSupport($varWhr, $limit = '');
        ...
        $this->arrRows = $objSupport->viewAllSupport($varWhr, $this->varLimit);
        //echo '<pre>';print_r($this->arrRows);die;
        $this->varSortColumn = $objSupport->getSortColumn($_REQUEST);
