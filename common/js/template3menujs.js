...
$(document).ready(function(){
    ...
    $(document).on('click', '.categorySubMenuProduct', function() { 
        ...
        $.ajax({
            ...
            data: {action: 'getSubCategoryProductTemplate3', cid: catProductId, wid: catWholId},
            type: 'post',
            async: false,
            beforeSend: function() {
                $('#wh_product').html('<div class="padd_content"><div class="offers"><img src="common/images/loader1.gif"/></div></div>');
                $('.main_div').hide();
