        ...
        <div class="container-fluid" id="content">
                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                ...
                                <div class="box box-color box-bordered">
                                    <div class="box-title">
                                        <h3>Add-Price</h3>
                                        <a id="buttonDecoration" href="zone_price_manage_uil.php" class="btn pull-right"><i class="icon-circle-arrow-left"></i> <?php echo ADMIN_BACK_BUTTON; ?></a>
                                    </div>
                                                                    ...
                                                                    <div class="TemplateBlock">
                                                                        <table class="table table-bordered dataTable-scroll-x" style="border: 1px solid #ccc;margin-bottom: 25px;float: left;">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <?php
                                                                                    $currentzonearry = $objGeneral->zonelistofcurrentlogist($objPage->logisticId);
                                                                        ...
                                                                        <div style="float:left;margin-left: -21px;position: relative;left: 43px;display: inline-block; " class="PlusMinus">
                                                                            <i>
                                                                                <span style="cursor: pointer;width:51px;" class="plusPriceFormAdmin">
            ...
            <!--                                                                            <i><span valueOfJ="0" valueOfI="1" zoneid="11"style="cursor: pointer;width:51px;" title="Delete Complete zone" class="zoneeditRemove"><img src="../admin/images/minus.png"/></span></i>-->
                                                            ...
                                                            <div class="form-actions formactionleft">                        
                                                                ...
                                                                <input type="hidden" name="logisticValueHidden" id="logisticValueHidden" value="<?php echo $objPage->logisticId; ?>" />
                                                            </div>
