...
<html>
    <head>
        ...
        <title><?php echo ADMIN_PANEL_NAME; ?> : Edit-Shipping Countries</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="breadcrumbs">
                        <ul>
                            ...
                            <li>
                                <span>Edit-Shipping Countries</span>
                            </li>
                        </ul>
...
//                                                                         }
                                                                        //pre($objPage->arrRow[0]['fkAdminID']);
                                                                        //pre($objPage->arrRow);
                                                                        ...
                                                                        $selectvalue=(int)$objPage->arrRow[0]['fkAdminID'];
                                                                        //echo gettype($selectvalue); die;
                                                                        //pre($selectvalue);
                                                                        echo $objGeneral->CountryPortalHtmlcountries($abc, 'countriesportal', 'pkAdminID', $selectvalue, 'Select Country Portal', '', $html_entity, '1', '1');
                                                                        ?>
                                                                </div>
                                                            </div>
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">                                                                    
                                                                    <?php
                                                                        ...
                                                                        $arrRows = $objShippingGateway->shippingCountryPortalList("fkportalID = " . (int)$objPage->arrRow[0]['fkAdminID']);
                                                                       //pre($arrRows);
                                                                      $selectedvalue=$objPage->arrRow[0]['fkShippingGatewaysID'];
                                                                        //pre($objPage->arrRow[0]['fkShippingGatewaysID']);
                                                                        ?>
                                                                        ...
                                                                        <option value="0">Select Shipping Geteway</option>
																		 ...
																		 foreach ($arrRows as $vv) {
																		 	//in_array($gatway,)
																		 	if($selectedvalue == $vv['pkShippingGatewaysID'])
																		 	echo '<option selected value='.$vv['pkShippingGatewaysID'].'>'.$vv['ShippingTitle'].'</option>';
																		 	else{	
																		 	echo '<option value='.$vv['pkShippingGatewaysID'].'>'.$vv['ShippingTitle'].'</option>';
																		 	}
																		 }
																		  //}
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">                                                                    
                                                                    <?php 
																		...
																		foreach ($objPage->arrRow as $kk => $vv) {
                                                                            $SelectedCountry[$kk] = $vv['fkcountry_id'];
                                                                        }
                                                                             //pre($SelectedCountry);
                                                                             echo $objGeneral->CountryHtml($abc, 'name[]', 'country_id', $SelectedCountry, '', 1, 'onchange="showAttribute(this.value);" class="select2-me input-xlarge" style="width:auto"', '1', '1'); ?>
                                                            ...
                                                            <div class="form-actions">
                                                                ...
                                                                <a id="buttonDecoration" href="shipping_countries_uil.php">
                                                                ...
                                                                <input type="hidden" name="PkEditId" value="<?php echo $_REQUEST['smid']; ?>" />
