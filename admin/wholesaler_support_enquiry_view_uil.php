                ...
                <div class="container-fluid">
                    ...
                    <div class="breadcrumbs">
                        <ul>
                            ...
                            <li>
                                <a href="dashboard_uil.php">Recent Support</a>
                                <i class="icon-angle-right"></i>
                            </li>
                            <li>
                                <!--<a href="wholesaler_support_enquiry_view_uil.php?id=<?php echo $_GET['id']; ?>&type=edit">Support Enquiries</a>-->
                                                            ...
                                                            if ($rowsNum > 0) {
                                                                        ...
                                                                        <td>
                                                                            <table cellpadding="0" cellspacing="0" border="0" class="left_content" style="width:100%;" >
                                                                                <tr>
                                                                                    ...
                                                                                    <td><?php echo $valRows['wholesalerName']; ?></td>
                                                                ...
                                                                <tr class="content">                                                
                                                                    <td style="text-align:center;">
                                                                        <a class="suspend btn btn-blue" href="#modal-1" onclick="return jscall1()"><?php echo ADMIN_REPLY_BUTTON; ?></a>                                                                        
                                                                    </td>
                                                                </tr>	
                                                            <?php } else { ?>
                                                                <tr class="content">                                                
        ...
        <div id="modal-1" class="modal hide" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:700px;">
            ...
            <form action=""  method="post" id="frm_page" enctype="multipart/form-data" >
                ...
                <div class="modal-body" style="padding-left:42px;padding-right:10px;">
                    <div class="rowlbinp">
                        <div class="lbl"><strong>To : </strong>   <?php echo $objPage->arrRow[0]['wholesalerEmail']; ?></div>
                    </div>
                    <div class="rowlbinp">
                ...
                <div class="modal-footer">
                    ...
                    <input id="frmToUserType" name="frmToUserType" type="hidden" value="wholesaler"/>
