...
<html>
    <head>
        ...
        <title><?php echo ADMIN_PANEL_NAME; ?> : Edit Home Banner</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="breadcrumbs">
                        <ul>
                            ...
                            <li><span>Edit Home Banner</span></li>
                        </ul>
                                    ...
                                    <div class="span12">
                                        ...
                                        <div class="box box-color box-bordered">
                                            ...
                                            <div class="box-content nopadding">
                                                ...
                                                <?php
                                                if ($_SESSION['sessUserType'] == 'super-admin' || in_array('edit-home-slider', $_SESSION['sessAdminPerMission']))
                                                {
                                                    ?>
                                                    <form action="" method="post" id="frm_page" onsubmit="return validateBannerPageForm(1);" enctype="multipart/form-data" > <div class="row-fluid">
                                                            <div class="span12 form-horizontal form-bordered box box-bordered box-color lightgrey">
                                                                        ...
                                                                        <div class="controls">
                                                                            <table class="table table-hover table-nomargin table-bordered usertable" style="width: auto;">
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    {
                                                                                        //pre($objPage->arrRow[0]['BannerTitle']);
                                                                                       // pre($objCore->getUrl('special.php', array('fname' => $objPage->arrRow[0]['BannerTitle'], 'cid' => 0, 'fid' => $objPage->arrRow[0]['fkFestivalID'])));
                                                                                        ?>
                                                                                        <tr>
                                                                                            <td>All category</td>
                                                                                            <td>
                                                                                                <?php echo $objCore->getUrl('special.php', array('fname' => $objPage->arrRow[0]['BannerTitle'], 'cid' => 0, 'fid' => $objPage->arrRow[0]['fkFestivalID'])); ?>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <?php
                                                                                    }
                                                                        ...
                                                                        <div class="controls">
                                                                            <table class="table table-hover table-nomargin table-bordered usertable" id="HomeBannerTbl">
                                                                                ...
                                                                                <tbody>
                                                                                    <?php
                                                                                    $i = 0;
                                                                                    foreach ($arrRow[0]['arrLinks'] as $key => $val)
                                                                                    {
                                                                                        $i++;
                                                                                        ?>
                                                                                        <tr>
                                                                                            <td>
                                                                                                <textarea name="frmCoOrdinates[<?php echo $i; ?>]" readonly="readonly"><?php echo $val['linkImagePosition'] ?></textarea>
                                                                                            </td>
                                                                                            <!--
                                                                                             <td>
                                                                                                 <input type="text" name="frmOffer[<?php echo $i; ?>]" value="<?php echo $val['Offer'] ?>" />
                                                                                             </td>
                                                                                            -->
                                                                                            <td>
                                                                                                <textarea name="frmUrl[<?php echo $i; ?>]" class="frm_url"><?php echo $val['UrlLinks']; ?></textarea>
                                                                                                <?php
                                                                                                //$arrcids = explode(',', $val['CategoryIds']);
                                                                                                // echo $objGeneral->CategoryHtml($objPage->arrCategoryDropDown, 'frmCategoryId[' . $i . '][]', '', $arrcids, '', 1, 'style="height:200px;width:300px"');
                                                                                                ?>&nbsp;
                                                                                            </td>
                                                                                            <td>
                                                                                                <a href="#" onclick="removeRowFromTableForHomeBanner('HomeBannerTbl','<?php echo $i; ?>',this);return false;"><img src="images/minus.png" /></a><i r="<?php echo $i; ?>"></i>
                                                                                            </td>
                                                                                        </tr>
                                                                                    <?php } ?>
                                                                                </tbody>
                                                                ...
                                                                else
                                                                {
                                                                    ...
                                                                    <div class="control-group">
                                                                        ...
                                                                        <div class="controls">
                                                                            <div style="float: left;margin-right: 10px;">
                                                                                <span style="color: #555555;margin-right: 10px">Filter By country: </span>
                                                                                <select name="frmCountry" id="frmCountry" class="select2-m input-large" onchange="showFestival(this.value,'frmFestival',0)">
                                                                                    <option value="">Select</option>
                                                                                    <option value="0" <?php echo ($arrRow[0]['CountryIDs'] == '0') ? 'selected="selected"' : '' ?>>All Country</option>
                                                                                    <?php
                                                                                    foreach ($objPage->arrCountry as $v)
                                                                                    {
                                                                                        ?>
                                                                                        <option value="<?php echo $v['country_id']; ?>" <?php echo ($v['country_id'] == $arrRow[0]['CountryIDs']) ? 'selected="selected"' : '' ?>><?php echo $v['name']; ?></option>
                                                                                    <?php } ?>
                                                                                </select>
                                                                            </div>
                                                                            <div style="float: left">
                                                                                <select name="frmFestival" id="frmFestival" class="select2-m input-large">
                                                                                    <option value="">Select</option>
                                                                                    <?php
                                                                                    foreach ($objPage->arrFestival as $val)
                                                                                    {
                                                                                        ?>
                                                                                        <option value="<?php echo $val['pkFestivalID']; ?>" <?php echo ($val['pkFestivalID'] == $arrRow[0]['fkFestivalID']) ? 'selected="selected"' : '' ?>><?php echo $val['FestivalTitle']; ?></option>
                                                                                    <?php } ?>
                                                                                </select>
                                                                            </div>
                                                                    ...
                                                                    <div class="control-group">
                                                                        ...
                                                                        <div class="controls">
                                                                            <?php
                                                                            $varSrc = UPLOADED_FILES_URL . 'images/banner/120x80/' . $arrRow[0]['BannerImageName'];
                                                                            ?>
