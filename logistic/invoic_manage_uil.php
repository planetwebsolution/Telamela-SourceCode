...
require_once CONTROLLERS_LOGISTIC_PATH . FILENAME_LOGISTICPORTAL_INVOICE_CTRL;
                                                         ...
                                                         //   pre($objPage->arrRows);
                                                            ...
                                                            foreach ($objPage->arrRows as $val) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class='hidden-480'><?php
																	//pre($objGeneral->getshippingcompanyname($val['fkShippingGatewaysID']));
																	$shippingtitle=$objGeneral->getshippingcompanyname($val['fkShippingGatewaysID']);
                                                                    echo $shippingtitle[0]['ShippingTitle']; ?> </td>
                                                                
                                                                    <td><?php echo ADMIN_CURRENCY_SYMBOL . $objCore->price_format($val['shippingAmount']); ?> </td>
                                                                    
                                                                    <td class='hidden-480 <?php echo ($val['Status']=='Canceled') ? 'red':''?>'><?php echo $val['Status'];?> </td>
                                                                    <td>
                                                                        <?php
