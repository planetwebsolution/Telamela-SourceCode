            ...
            <div class="right_product"><div class="quick_title_1"><span><?php echo $objCore->getProductName($productdetails['ProductName'], 30); ?></span>	</div>
                ...
                <div class="content_left">
                    ...
                    if($productdetails['offerPrice']>0 && $productdetails['offerPrice']!=''){ ?>
                        <div class="price">
                        <?php echo $objCore->getFinalPrice($productdetails['FinalPrice'], $productdetails['offerPrice'], $productdetails['FinalSpecialPrice'], 0, 1);
                        $varProductPrice = $objCore->getFinalPrice($productdetails['FinalPrice'], $productdetails['offerPrice'], $productdetails['FinalSpecialPrice'], 1, 1);
                    ...
                    <?php }else{ ?>
                        <div class="price">
                        <?php echo $objCore->getFinalPrice($productdetails['FinalPrice'], $productdetails['DiscountFinalPrice'], $productdetails['FinalSpecialPrice'], 0, 1); ?>
