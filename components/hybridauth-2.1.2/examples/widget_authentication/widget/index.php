...
<body>
	<div id="idps">
			...
			<!-- <img class="idpico" idp="openid" src="images/icons/openid.png" title="openid" />  		 
			<img class="idpico" idp="yahoo" src="images/icons/yahoo.png" title="yahoo" />
			<img class="idpico" idp="flickr" src="images/icons/flickr.png" title="flickr" />
			<img class="idpico" idp="myspace" src="images/icons/myspace.png" title="myspace" />		  
			<img class="idpico" idp="blogger" src="images/icons/blogger.png" title="blogger" /> 
			<img class="idpico" idp="wordpress" src="images/icons/wordpress.png" title="wordpress" />
			<img class="idpico" idp="livejournal" src="images/icons/livejournal.png" title="livejournal" /> -->  
