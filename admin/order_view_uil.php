                                    ...
                                    <div class="span12">
                                        ...
                                        <div class="box box-color box-bordered">
                                            <div class="box-title">
                                                ...
                                                if ($varNum > 0) {
                                                    ?>
                                                    <a id="buttonDecoration" href="order_print_uil.php?type=sendInvoice&soid=<?php echo $_GET['soid']; ?>" class="btn pull-right" style="margin-right: 10px;">Send Invoice To Customer</a>
                                                    <?php
                                                    if (count($arrDisputedCommentsHistory) > 0) {
                                                        ?>
                                                        <a href="#listed_Suspend" onclick="return jscall1('disputedHistory');" class="btn pull-right" style="margin-right: 10px;">Disputed History</a>
...
<!--                                                                                <td class="detailshead">Shipment</td>-->
                                                                            ...
                                                                            foreach ($arrOrderItem as $item) {
                                                                                ...
                                                                                <tr id="tr<?php echo $item['pkOrderItemID']; ?>">
                                                                                    ...
                                                                                    <td><?php echo number_format($item['SingleDeductionValue'], 2); ?></td>
                                                                                    <td><?php echo number_format($item['ItemTotalPrice'], 2); ?></td>
<!--                                                                                    <td>
                                                                                        <?php
