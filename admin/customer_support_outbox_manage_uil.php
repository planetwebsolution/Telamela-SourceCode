                ...
                <div class="container-fluid">
                    ...
                    <div class="breadcrumbs">
                        <ul>
                            ...
                            <li>
                                <span>Customer Support Outbox</span>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach ($objPage->arrRows as $val) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="customer_support_outbox_view_uil.php?id=<?php echo $val['pkSupportID']; ?>&type=edit" class="btn" rel="tooltip" title="" data-original-title="View"><i class="icon-eye-open"></i></a> 
