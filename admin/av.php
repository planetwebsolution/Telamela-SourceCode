  ...
  <tr class="content">
    <td width="48%" valign="top" align="left" style="font-family:Arial, Helvetica, sans-serif; border:0; text-align: left;color: #333;padding: 4px 4px 4px 6px;font-size: 12px;"><table cellpadding="0" cellspacing="0" border="0" class="left_content table_border" style="font-family:Arial, Helvetica, sans-serif; width: 100%;border: 1px solid #c3c4c6;padding: 0px;border-top: none;border-bottom: none;border-right: none;">
        ...
        <tr class="content">
          ...
          <td class="admin_left_input" style="font-family:Arial, Helvetica, sans-serif; text-align: left;width: 50%;color: #333;border-right: 1px solid #c3c4c6;border-bottom: 1px solid #c3c4c6;padding: 4px 4px 4px 6px;font-size: 12px;"><?php echo $objPage->arrlogistic[0][TransactionStatus]?></td>
        </tr>
      </table></td>
  ...
  <tr class="content">
    <td width="48%" valign="top" align="left" style="font-family:Arial, Helvetica, sans-serif;border: none;text-align: left;color: #333;padding: 4px 4px 4px 6px;font-size: 12px;"><table cellpadding="0" cellspacing="0" border="0" class="left_content table_border" style="font-family:Arial, Helvetica, sans-serif;width: 100%;border: 1px solid #c3c4c6;padding: 0px;border-top: none;border-bottom: none;border-right: none;">
        ...
        <tr class="content">
          ...
          <td class="admin_left_input" style="font-family:Arial, Helvetica, sans-serif;text-align: left;width: 50%;color: #333;border-right: 1px solid #c3c4c6;border-bottom: 1px solid #c3c4c6;padding: 4px 4px 4px 6px;font-size: 12px;">&nbsp;</td>
        </tr>
        <tr class="content">
        ...
        <tr class="content">
          ...
          <td class="admin_left_input" style="font-family:Arial, Helvetica, sans-serif;text-align: left;width: 50%;color: #333;border-right: 1px solid #c3c4c6;border-bottom: 1px solid #c3c4c6;padding: 4px 4px 4px 6px;font-size: 12px;"><?php echo $objPage->arrorderdata[0][BillingCountry] ?></td>
        </tr>
        <tr class="content">
    ...
    <td width="48%" valign="top" align="left" style="font-family:Arial, Helvetica, sans-serif;border: none;text-align: left;color: #333;padding: 4px 4px 4px 6px;font-size: 12px;"><table cellpadding="0" cellspacing="0" border="0" class="left_content table_border" style="font-family:Arial, Helvetica, sans-serif;width: 100%;border: 1px solid #c3c4c6;padding: 0px;border-top: none;border-bottom: none;border-right: none;">
        ...
        <tr class="content">
          <td class="admin_left_text" style="font-family:Arial, Helvetica, sans-serif;text-align: left;width: 50%;font-weight: bold;color: #333;border-right: 1px solid #c3c4c6;border-bottom: 1px solid #c3c4c6;padding: 4px 4px 4px 6px;font-size: 12px;"> Country</td>
          <td class="admin_left_input" style="font-family:Arial, Helvetica, sans-serif;text-align: left;width: 50%;color: #333;border-right: 1px solid #c3c4c6;border-bottom: 1px solid #c3c4c6;padding: 4px 4px 4px 6px;font-size: 12px;"><?php echo $objPage->arrorderdata[0][ShippingCountry] ?></td>
        </tr>
        <tr class="content">
          <td class="admin_left_text" style="font-family:Arial, Helvetica, sans-serif;text-align: left;width: 50%;font-weight: bold;color: #333;border-right: 1px solid #c3c4c6;border-bottom: 1px solid #c3c4c6;padding: 4px 4px 4px 6px;font-size: 12px;"> Post Code or Zip Code:</td>
  ...
  <tr class="content">
    <td width="48%" colspan="3" valign="top" align="left" style="font-family:Arial, Helvetica, sans-serif;border: none;text-align: left;color: #333;padding: 4px 4px 4px 6px;font-size: 12px;"><table cellpadding="0" cellspacing="0" border="0" class="left_content table_border" style="font-family:Arial, Helvetica, sans-serif;width: 100%;border: 1px solid #c3c4c6;padding: 0px;border-top: none;border-bottom: none;border-right: none;">
        ...
        <tr class="content">
          ...
          <td style="font-family:Arial, Helvetica, sans-serif;text-align: center;color: #333;border-right: 1px solid #c3c4c6;border-bottom: 1px solid #c3c4c6;padding: 4px 4px 4px 6px;font-size: 12px;"><b><?php echo $objPage->arrorderdataitem[0][ItemName]?></b><br/><br>
           <?php echo $objPage->arrorderdataitem[0][ItemName]?><br></td>
           <?php $imgsrc=$objPage->arrorderdataitem[0][ItemImage];
          ...
          <td style="font-family:Arial, Helvetica, sans-serif;text-align: center;color: #333;border-right: 1px solid #c3c4c6;border-bottom: 1px solid #c3c4c6;padding: 4px 4px 4px 6px;font-size: 12px;"><?php echo $objPage->arrorderdataitem[0][Quantity]?></td>
          
          <td style="font-family:Arial, Helvetica, sans-serif;text-align: center;color: #333;border-right: 1px solid #c3c4c6;border-bottom: 1px solid #c3c4c6;padding: 4px 4px 4px 6px;font-size: 12px;"><?php  echo $objPage->arrlogistic[0][shippingAmount]?></td>
  ...
  <tr class="content">
    ...
    <td width="48%" valign="top" align="left" style="font-family:Arial, Helvetica, sans-serif;border: none;text-align: left;color: #333;padding: 4px 4px 4px 6px;font-size: 12px;"><table cellpadding="0" cellspacing="0" border="0" class="left_content table_border" style="font-family:Arial, Helvetica, sans-serif;width: 100%;border: 1px solid #c3c4c6;padding: 0px;border-top: none;border-bottom: none;border-right: none;">
        ...
        <tr class="content">
          ...
          <td class="admin_left_input" style="font-family:Arial, Helvetica, sans-serif;text-align: left;width: 50%;color: #333;border-right: 1px solid #c3c4c6;border-bottom: 1px solid #c3c4c6;padding: 4px 4px 4px 6px;font-size: 12px;"><?php  echo $objPage->arrlogistic[0][shippingAmount]?></td>
        </tr>
      </table></td>
  </tr>
  <tr class="content">
