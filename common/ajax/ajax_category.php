...
switch ($varcase) {
    ...
    case 'SelectLeftPanel':
        ...
        <div id="exCategory">
            <?php
            //print_r($objPage->arrWholeSalerList);
                        ...
                        <div class="scroll-pane category_left">
                            <ul class="parent_check">
                                ...
                                foreach ($objPage->arrWholeSalerList as $wholeSalerList) {
                                    if (in_array($wholeSalerList['pkWholesalerID'], $objPage->DeactiveWhID)) {
                                        continue;
                                    }
                                    ?>
                                    <li>
            ...
            <script>
                var p11 = '<?php echo (int) $_REQUEST['frmPriceFrom'] != '' ? (int) $_REQUEST['frmPriceFrom'] : 0; ?>';
                var p22 = '<?php echo (int) $_REQUEST['frmPriceTo'] != '' ? (int) $_REQUEST['frmPriceTo'] : 0; ?>';
                ...
                $(document).ready(function () {
                    var p2 = parseInt(priceSliderTo);
                    var p1 = parseInt(priceSliderFrom);
                    $('.range-slider').jRange({
                        from: p1,
                        to: p2,
                        step: 1,
            ...
            <div class="category_list">
                ...
                <div class="toggle">
                    ...
                    <div class="price_range">
                        ...
                        <label><!-- Search Price range --> <span style="float:left;"><?php echo (int) $_REQUEST['frmPriceFrom'] != '' ? (int) $_REQUEST['frmPriceFrom'] : 0; ?> - <?php echo (int) $_REQUEST['frmPriceTo'] != '' ? (int) $_REQUEST['frmPriceTo'] : 0; ?></span> </label>


                        <?php /* <input type="text" name="frmPriceFrom" id="frmPriceFrom" onkeyup="Javascript: if (event.keyCode==13) prc('1');" value="<?php echo (int) $objPage->arrPriceRange['min']!=''?(int) floor($objCore->getRawPrice($objPage->arrPriceRange['min'],0)):(int) $_REQUEST['frmPriceFrom'];?>"/> */ ?>
                        <input type="text" name="frmPriceFrom" id="frmPriceFrom" onkeyup="Javascript: if (event.keyCode == 13)
                                            prc('1');" value="<?php echo (int) $_REQUEST['frmPriceFrom'] != '' ? (int) $_REQUEST['frmPriceFrom'] : (int) $_REQUEST['frmPriceFrom']; ?>"/>
                        <small></small>
                        <?php /* <input type="text" name="frmPriceTo" id="frmPriceTo" onkeyup="Javascript: if (event.keyCode==13) prc('1');" value="<?php echo (int) $objPage->arrPriceRange['max']!=''?(int) ceil($objCore->getRawPrice($objPage->arrPriceRange['max'],0)):(int) $_REQUEST['frmPriceTo'];?>"/> */ ?>
                        <input type="text" name="frmPriceTo" id="frmPriceTo" onkeyup="Javascript: if (event.keyCode == 13)
                                    prc('1');" value="<?php echo (int) $_REQUEST['frmPriceFrom'] != '' ? (int) $_REQUEST['frmPriceTo'] : (int) $_REQUEST['frmPriceTo']; ?>"/>
                        <input type="button" onclick="prc('1')" value="Go"/>
                    </div>
                    <div class='price_slider'>
                        <?php $MinPriceForRang = ($_REQUEST['frmPriceFrom'] < $_REQUEST['defaultfromPrice']) ? $_REQUEST['defaultfromPrice'] : $_REQUEST['frmPriceFrom']; ?>
                        <?php $MaxPriceForRang = ($_REQUEST['frmPriceTo'] > $_REQUEST['defaultToPrice']) ? $_REQUEST['defaultToPrice'] : $_REQUEST['frmPriceTo']; ?>
                        <?php /* <input class="range-slider1" type="hidden" value="<?php echo (int) floor($objCore->getRawPrice($objPage->arrPriceRange['min'], 0)); ?>,<?php echo (int) ceil($objCore->getRawPrice($objPage->arrPriceRange['max'], 0)); ?>"/> */ ?>
                        <input class="range-slider" type="hidden" value="<?php echo (int) $MinPriceForRang; ?>,<?php echo (int) $MaxPriceForRang; ?>"/>
