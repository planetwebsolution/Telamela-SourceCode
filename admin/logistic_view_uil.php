                                        ...
                                        <form id="frmSearch" method="get" action="" class="form-horizontal form-bordered" onSubmit="return dateCompare('frmSearch');">
                                            <div class="row-fluid">
                                                <div class="row-fluid" style="margin-bottom:5px;">
                                                    ...
                                                    <div class="span4">
                                                        <div class="control-group">
                                                            <label for="textfield" class="control-label">Logistic Date:  </label>
                                                            <div class="controls">
                                    ...
                                    <div class="box-content nopadding manage_categories">
                                        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
                                            ...
                                            if ($objPage->NumberofRows > 0) {
                                                ?>
                                                <form id="frmProcess" name="frmProcess" action="logisticinvoice_action.php" method="post">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach ($objPage->arrRows as $val) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class='hidden-480'><?php echo $val['CustomerID'];//$objCore->localDateTime($val['OrderDateAdded'], DATE_FORMAT_SITE); ?> </td>
                                                                    <td class='hidden-480'><?php echo $val['fkShippingGatewaysID']; ?> </td>
...
//                                                                         if ($exists) {
//                                                                             ?>
  <a class="btn" rel="tooltip" data-original-title="View" href="logistic_view_uil.php?type=view&id=<?php echo $val['pkInvoiceID']; ?>"><i class="icon-eye-open"></i></a>                                        
...
//                                                                         }
                                                                        ...
                                                                        <?php // }  ?>
                                                                        <a class='btn' data-original-title="Delete" rel="tooltip" title="" href="invoice_action.php?frmID=<?php echo $val['pkInvoiceID']; ?>&frmProcess=ManipulateInvoice&frmChangeAction=Delete&deleteType=sD" onClick='return fconfirm("Are you sure you want to delete this discount invoice?", this.href);'><i class="icon-remove"></i></a>
