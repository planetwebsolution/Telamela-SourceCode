                                                        ...
                                                        <div class="nopadding">
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                    ...
                                                                    <select name="frmShippingGatewayID" id="frmShippingGatewayID" onchange="showShippingMethod(this.value,0,'frmShippingMethodID');" class='select2-me input-large'>
                                                                        <option value="0">Select Shipping Gateways</option>
                                                                        <?php foreach ($objPage->arrShippingGatewaysList as $key => $val) { ?>
                                                                            <option value="<?php echo $val['pkShippingGatewaysID']; ?>"><?php echo $val['ShippingTitle']; ?></option>
                                                                        <?php } ?>
                                                                    </select>
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                    <select name="frmShippingMethodID" id="frmShippingMethodID" class='select2-me input-large'>
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls" style="width: 72%; overflow: auto">
                                                                    <table class="table table-bordered dataTable-scroll-x" id="productRow">
                                                                        ...
                                                                        <tr>
                                                                            <td><input type="text" name="frmWeight[]" class="input0" style="width:51px" /></td>
                                                                            <td><input type="text" name="frmA[]" class="input0" style="width:51px"/></td>
                                                                            <td><input type="text" name="frmB[]" class="input0" style="width:51px"/></td>
                                                                            <td><input type="text" name="frmC[]" class="input0" style="width:51px"/></td>
                                                                            <td><input type="text" name="frmD[]" class="input0" style="width:51px"/></td>
                                                                            <td><input type="text" name="frmE[]" class="input0" style="width:51px"/></td>
                                                                            <td><input type="text" name="frmF[]" class="input0" style="width:51px"/></td>
                                                                            <td><input type="text" name="frmG[]" class="input0" style="width:51px"/></td>
                                                                            <td><input type="text" name="frmH[]" class="input0" style="width:51px"/></td>
                                                                            <td><input type="text" name="frmI[]" class="input0" style="width:51px"/></td>
                                                                            <td><input type="text" name="frmJ[]" class="input0" style="width:51px"/></td>
                                                                            <td><input type="text" name="frmK[]" class="input0" style="width:51px"/></td>
                                                                            <td><i><span style="cursor: pointer;width:51px;"  onclick="addDynamicRowToTableForShippingGateways('productRow');"><img src="images/plus.png"/><!--<i class="icon-plus-sign"></i>--></span></i></td>
                                                                        </tr>
                                                                    </table>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-actions">
                                                                ...
                                                                <a id="buttonDecoration" href="shipping_gateway_manage_uil.php"><input type="button" class="btn" name="btnTagSettings" value="<?php echo ADMIN_SEARCH_CANCEL_BUTTON; ?>" style="float:left; margin:5px 5px 0 0; width:80px;"/></a>
