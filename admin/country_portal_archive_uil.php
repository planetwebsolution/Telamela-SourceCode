                                        ...
                                        if (count($objPage->arrRows) > 0)
                                        {
                                            ...
                                            <table class="table table-hover table-nomargin table-bordered usertable">
                                                ...
                                                <tbody>
                                                    ...
                                                    {
                                                        $Commission = ($val['Commission'] * $val['TotalAmount']) / 100;
                                                        ?>
                                                        <tr>
                                                            <td><?php echo $objCore->localDateTime($val['StartDate'], DATE_FORMAT_SITE); ?></td>
                                                            <td><?php echo $objCore->localDateTime($val['EndDate'], DATE_FORMAT_SITE); ?></td>
                                                            <td class="hidden-480"><?php echo $val['SalesTarget']; ?></td>
                                                            <td class="hidden-480"><?php echo $val['AchivedTarget']; ?></td>
                                                            <td class="hidden-480"><?php echo number_format($val['TotalAmount'], 2); ?></td>
                                                            <td><?php echo number_format($Commission, 2); ?></td>
                                                            <td class="hidden-480"><?php echo number_format($val['Commission'], 2); ?></td>
                                                        </tr>
                                                    <?php }
                                                    ?>
                                                </tbody>
