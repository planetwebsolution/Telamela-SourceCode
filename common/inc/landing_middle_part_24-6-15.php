...
<div class="breadcrumb"><a href="<?php echo SITE_ROOT_URL; ?>">Home</a> <i class="arrow"></i>  <span> <?php echo $_GET['name']; ?>  Products</span>       </div>
<!--START H1-->
    ...
    <div class="landing_section">
        <div class="section_divide">
            ...
            <div class="left_block">
                <a href="javascript:void(0)"><img src="<?php echo IMAGE_PATH_URL; ?>landing_big_img.jpg" alt="" class="bidImage" /></a>
            </div>
            <!-- Left Block big image section -->
                            ...
                            <div class="row">
                                <div class="span12">
                                    <div  class="owl-demo8">
                                        <!--Section Start-->
                                                        <?php
                                                        foreach ($objPage->arrData['topRatedProducts'] as $key => $val)
                                                        { //pre($val);
                                                            if ($val['Quantity'] == 0)
                                                            {
