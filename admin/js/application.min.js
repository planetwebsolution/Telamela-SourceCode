...
function slimScrollUpdate(e,t){
    if(e.length>0){
        var n=parseInt(e.attr("data-height")),r=e.attr("data-visible")=="true"?!0:!1,i=e.attr("data-start")=="bottom"?"bottom":"top",s={
            height:n,
            color:"#666",
            start:i
        };
...
function getSidebarScrollHeight(){
    var e=$("#left"),t=$(window),n=$("#navigation"),r=t.height();
...
function resizeHandlerHeight(){
    var e=$(window).height(),t=$(window).scrollTop()==0?40:0;
...
function getNavElement(e){
    var t=$.trim(e.find(">a").text()),n="";
    var st = '';
    if(e.find(">.dropdown-menu li").length==1){       
        st='onclick="ndrop(this)"';
    };
    n+="<li "+st+"><a href='"+e.find(">a").attr("href")+"'>"+t+"</a>";
...
$(document).ready(function(){
    ...
    $(".subnav-menu > li > a[data-toggle=dropdown]").click(function(){
        ...
        if($("#left").hasClass("sidebar-fixed")||$("#left").hasClass("mobile-show")){
            $(".cloned").remove();
            var t=e.next(),n=e.offset(),r=t.clone().css({
                top:n.top,
    ...
    $("body").on("click",".change-input",function(e){
        e.preventDefault();
        var t=$(this),n=t.parent().prev(),r=t.parent().clone();
        r.html(n.clone().val(""));
        n.after(r);
    ...
    $(".content-slideUp").click(function(e){
        e.preventDefault();
        var t=$(this),n=t.parents(".box").find(".box-content");
    ...
    $(".content-remove").click(function(e){
        e.preventDefault();
        var t=$(this),n=t.parents("[class*=span]"),r=parseInt(n.attr("class").replace("span","")),i=n.prev().length>0?n.prev():n.next();
    ...
    $(".tasklist").on("click","li",function(e){
        var t=$(this),n=$(this).find("input[type=checkbox]").first();
        t.toggleClass("done");
    ...
    $(".tasklist").on("click",".task-bookmark",function(e){
        var t=$(this),n=$(this).parents("li"),r=$(this).parents("ul");
        e.preventDefault();
        e.stopPropagation();
    ...
    $(".scrollable").length>0&&$(".scrollable").each(function(){
        var e=$(this),t=parseInt(e.attr("data-height")),n=e.attr("data-visible")=="true"?!0:!1,r=e.attr("data-start")=="bottom"?"bottom":"top",i={
            height:t,
            color:"#666",
            start:r,
            allowPageScroll:!0
    ...
    $(".new-task-form").submit(function(e){
        e.preventDefault();
        $("#new-task").modal("hide");
        var t=$(this),n=$(".tasklist"),r=t.find("select[name=icons]"),i=t.find("input[name=task-name]"),s=t.find("input[name=task-bookmarked]");
        if(i.val()!=""){
            var o="";
    ...
    $("#left").hasClass("no-resize")||$("#left").resizable({
        ...
        handles:"e",
        resize:function(e,t){
            var n=$(".search-form .search-pane input[type=text]"),r=$("#main");
            n.css({
    ...
    $(".table-mail > tbody > tr").click(function(e){
        var t=$(this),n=t.find(".table-checkbox > input");
    ...
    $(".table .alpha").click(function(e){
        e.preventDefault();
        var t=$(this),n="ABCDEFGHIJKLMNOPQRSTUVWXYZ",r="",i=[];
