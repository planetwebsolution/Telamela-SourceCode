...
<html>
    <head>
        ...
        <style type="text/css">
           .select2-results .select2-disabled{ opacity:.4 !important; background: #DDD !important; cursor:not-allowed !important;}
                                            ...
                                            <div class="row-fluid">
                                                ...
                                                <div class="span4">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <select name="frmStatus" class=''>
                                                                <option value="">Select Order Status</option>
                                                                <option value="Pending" disabled <?php
                                                                if ($_GET['frmStatus'] == 'Pending') {
                                                                    echo 'Selected';
                                                                }
                                                                ?>>Pending</option>

                                                                <?php /* select21-me input-large<option value="Posted" <?php
                                                                ...
                                                                <option value="Completed" disabled<?php
                                                                if ($_GET['frmStatus'] == 'Completed') {
                                                                    echo 'Selected';
                                                                }
                                                                ?>>Completed</option>
                                                                <option value="Canceled" disabled <?php
...
<!--                                                        <th class='with-checkbox hidden-480'>
                                                        ...
                                                        <th class=' status'>Order Item Status</th>
...
<!--                                                                    <td class="with-checkbox hidden-480">
                                                                    ...
                                                                    <td class="hidden-480 status">
                                                                        ...
                                                                        <select name="frmStatus" onChange="changeOrderStatus(this.value, '<?php echo $val['SubOrderID']; ?>','<?php echo $portalmail; ?>','<?php echo $gatwayname; ?>',<?php echo $varPosted; ?>);" class='select2-me input-medium for-disabled'>
                                                                            <option value="Pending" disabled <?php
                                                                           ...
                                                                           <?php
                                                                           $disable='';
                                                                            if($val['DisputedStatus'] == 'Disputed')
                                                                            {
                                                                                $disable='disabled';
                                                                            }
                                                                           ?>
                                                                            <option value="Delivered" <?php echo $disable ?>
                                                                            <?php
