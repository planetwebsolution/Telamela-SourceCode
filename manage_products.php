...
//print_r($_SERVER);
//echo "</pre>";
unset($_SESSION['query_string']['wholesaler']['products_listing']);
if(isset($_SERVER['QUERY_STRING']) && $_SERVER['QUERY_STRING']!=''){
    $_SESSION['query_string']['wholesaler']['products_listing']=$_SERVER['QUERY_STRING'];
}
                                ...
                                if (count($objPage->arrProductList) > 0) {
                                    ...
                                    foreach ($objPage->arrProductList as $varProduct) {
                                        ...
                                        <tr class="<?php echo $varCounter % 2 == 0 ? 'even' : 'odd'; ?>">
                                            ...
                                            <td><?php echo '$' . number_format($varProduct['DiscountFinalPrice'], 2); ?></td>
                                            <?php if($countAttr>0){ ?>
