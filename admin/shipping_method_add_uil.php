...
<html>
    <head>
        ...
        <title><?php echo ADMIN_PANEL_NAME; ?> : Add-Shipping Method</title>
                                                    ...
                                                    <div class="box box-color box-bordered ">
                                                        <div class="nopadding">
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">                                                                    
                                                                    <input type="text" name="frmMethodName" id="frmMethodName" class="input-large" value="<?php echo $_POST['frmMethodName']; ?>" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                    <textarea name="frmMethodDescription" id="frmMethodDescription" class="input-large" rows="4"><?php echo $_POST['frmMethodDescription'];?></textarea>
                                                                </div>  
                                                            </div>
                                                            <div class="control-group">
                                                                    ...
                                                                    <div class="controls">       
                                                                        ...
                                                                        <input type="radio" name="frmStatus" id="frmStatus"  value="1" Checked="checked"/>Active&nbsp;&nbsp;&nbsp; 
