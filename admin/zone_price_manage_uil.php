                    ...
                    <?php if ($_SESSION['sessUserType'] == 'super-admin') {
                        ...
                        <div class="breadcrumbs">
                            <ul>
                                ...
                                <li><span>Logistic Companies</span></li>
                            </ul>
                        ...
                        <div class="row-fluid">
                            <div class="span12 margin_top20">
                                <div class="fleft">
                                    ...
                                    <!--<a href="zone_add_uil.php?type=add"><button class="btn btn-inverse">Add New</button></a>-->
                                </div>
                                <div class="fright">
...
//                                                                     pre($val);
                                                                    ...
                                                                    <td><?php echo $val['logisticTitle']; ?></td>

                                                                                                                    <!--<td class="hidden-480"><?php //echo $val['modified'];     ?></td>-->
                                                                    <td class="hidden-480">
                                                                        <?php /*<a class="btn" href="zone_add_uil.php?type=add&LogisticId=<?php echo $val['logisticportalid']; ?>&countryId=<?php echo $val['logisticportal']; ?>" rel="tooltip" title="" data-original-title="Add zone">
                                                                            <i class="icon-plus">
                                                                            </i>
                                                                        </a>*/ ?>
                                                                        <a class="btn" href="listing_zone_price.php?type=listingPrice&LogisticId=<?php echo $val['logisticportalid']; ?>" rel="tooltip" title="" data-original-title="View all prices">
