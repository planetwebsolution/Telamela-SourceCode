...
function addToAjaxCart(a,b,c,d)
{
    alert('well '+a+''+b+''+c+''+d);
}
...
function quantityCartPlusMinus(e,t,a,r,i,n,o,s,l,obj){
    ...
    if(a=a.replace(r,""),a=a.replace(",",""),a=a,t){
        ...
        if(d=$(u).val(),parseInt(d)>=parseInt(l)&&"1"==e){
            ...
            //alert(v+'=='+g);
            g=0!=v?parseFloat(f)-parseFloat(f)*parseFloat(v)/100:f,$("#subTotalP").html(r+f.toFixed(2)),$("#DiscountCouponP").html(0!=v?r+(parseFloat(f)*parseFloat(v)/100).toFixed(2):r+" 0.00"),$(".total_sec .last").find("strong").html(r+g.toFixed(2));
