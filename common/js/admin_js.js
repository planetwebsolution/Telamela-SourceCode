...
function showFinalPriceForMultipleProduct(e) {
    ...
    if ("" == t)
        return $("#FinalPrice" + e).html(""), $("#frmProductPrice" + e).val(""), !1;
...
function showFinalDiscountPriceForMultipleProduct(e) {
    ...
    if ("" == t)
        return $("#DiscountFinalPrice" + e).html(""), $("#frmDiscountFinalPrice" + e).val(""), !1;
    var a = parseFloat(t), i = parseFloat(r), n = a + a * i / 100;
...
function validateCouponForm() {
    ...
    if (e = n[1].checked ? 0 : 1, "" == trim(t.value))
        return alert("Coupon Name is Required!"), t.focus(), !1;
    if ("" == trim(r.value))
        return alert("Coupon Code is Required!"), r.focus(), !1;
    if ("1" == a.value)
        return alert("Coupon Code Already in use.Please enter different Coupon Code."), r.select(), !1;
    if ("" == i.value)
        return alert("Discount is Required!"), i.focus(), !1;
    if (parseFloat(i.value) < 0.01)
        return alert("Discount should be greater than 0 !"), i.focus(), !1;
    if (0 == AcceptDecimal(i.value))
        return alert("Please enter numeric or decimal value!"), i.select(), !1;
    if (i.value > 100)
        return alert("Discount should be less than or equal to 100!"), i.select(), !1;
    if (0 == e)
        for (var l = document.getElementsByName("frmCategoryId[]"), o = document.getElementsByName("frmProductId[]"), u = 0; u < l.length; u++) {
            if (0 == l[u].value)
                return alert("Please Select Category!"), l[u].focus(), !1;
            if (0 == o[u].value)
                return alert("Please Select Product!"), o[u].focus(), !1
        }
}
function validatePackageAddPageForm() {
    ...
    if ("0" == t.value)
        return alert("Please Select Wholesaler!"), t.focus(), !1;
    if (attr == '1') {
    ...
    for (var o = 0; o < r.length; o++) {
        if (0 == r[o].value)
            return alert("Please Select Category!"), r[o].focus(), !1;
        if (0 == a[o].value)
            return alert("Please Select Product!"), a[o].focus(), !1
    }

    for (var o = 0; o < a.length; o++)
        for (var u = o + 1; u < a.length; u++)
            if (a[o].value == a[u].value)
                return alert("Same product cannot be added more than once in a package."), a[u].focus(), !1;
    if ("" == i.value)
        return alert("Offer Price is Required!"), i.focus(), !1;
    if (0 == AcceptDecimal(i.value))
        return alert("Please Enter numeric or decimal value!"), i.focus(), !1;
    if (i.value < 0)
        return alert("Offer Price should not be negitive!"), i.focus(), !1;
    if (0 == IsLessThan(n.value, i.value))
        return alert("Offer Price should be less than Total Price !"), i.focus(), !1;
    if ("" == trim(e.value))
        return alert("Package Name is Required!"), e.focus(), !1;
    if ("" != l.value) {
        var s = l.value, m = s.substring(s.lastIndexOf(".") + 1), c = m.toLowerCase();
        if ("jpg" != c && "jpeg" != c && "gif" != c && "png" != c)
            return alert("Accepted Image formats are: jpg, jpeg, gif, png"), l.focus(), !1
    }
...
function validateProductAddForm(e, adit) {
    ...
    if ("" == e.frmProductName.value)
        return alert("Product Name is Required!"), e.frmProductName.focus(), !1;
    if ("" == e.frmProductRefNo.value)
        return alert("Product Ref No. is Required!"), e.frmProductRefNo.focus(), !1;
    if (1 == e.frmIsRefNo.value)
        return alert("Product Ref No. allready Exist. Please change !"), e.frmProductRefNo.focus(), !1;
    if (0 == e.frmfkCategoryID.value)
        return alert("Please Select Category !"), e.frmfkCategoryID.focus(), !1;
    if (e.frmWeight.value <= 0 || e.frmWeight.value == '')
        return alert("Weight can not be less then 1!"), e.frmWeight.focus(), !1;
    if (e.frmLength.value <= 0 || e.frmLength.value == '')
        return alert("Length can not be less then 1!"), e.frmLength.focus(), !1;
    if (e.frmWidth.value <= 0 || e.frmWidth.value == '')
        return alert("Width can not be less then 1!"), e.frmWidth.focus(), !1;
    if (e.frmHeight.value <= 0 || e.frmHeight.value == '')
        return alert("Height can not be less then 1!"), e.frmHeight.focus(), !1;
    if ("" == e.frmWholesalePrice.value)
        return alert("Wholesale Price is Required!"), e.frmWholesalePrice.focus(), !1;
    if (e.frmWholesalePrice1.value < 0)
        return alert("Wholesale Price can not be less then 1!"), e.frmWholesalePrice1.focus(), !1;
    if (e.frmWholesalePrice2.value < 0)
        return alert("Discount Price can not be less then 1!"), e.frmWholesalePrice2.focus(), !1;
    if (parseFloat(e.frmWholesalePrice.value) <= parseFloat(e.frmDiscountPrice.value))
        return alert("Discount price should be less than wholesaler price!"), e.frmDiscountPrice.focus(), !1;
    if (0 == AcceptDecimal(e.frmWholesalePrice.value))
        return alert("Please Enter numeric or decimal value!"), e.frmWholesalePrice.focus(), !1;
    if ("" == e.frmQuantity.value)
        return alert("Stock Quantity is Required!"), e.frmQuantity.focus(), !1;
    if (e.frmQuantity.value < 0)
        return alert("Quantity can not be less then 1!"), e.frmQuantity.focus(), !1;
    if (e.frmQuantityAlert.value < 0)
        return alert("Quantity Alert can not be less then 1!"), e.frmQuantityAlert.focus(), !1;
    if (1 == IsDigits(e.frmQuantity.value))
        return alert("Please Enter numeric value !"), e.frmQuantity.focus(), !1;
    if ("" != e.frmQuantityAlert.value && 1 == IsDigits(e.frmQuantityAlert.value))
        return alert("Please Enter numeric value !"), e.frmQuantityAlert.focus(), !1;
    if (0 == IsLessThan(e.frmQuantity.value, e.frmQuantityAlert.value))
        return alert("Sent alert message should be less than Stock Quantity !"), e.frmQuantityAlert.focus(), !1;
    if (0 == e.frmCountryID.value)
        return alert("Please Select Country !"), e.frmCountryID.focus(), !1;
    if (0 == e.frmfkWholesalerID.value)
        return alert("Please Select Wholesaler Name !"), e.frmfkWholesalerID.focus(), !1;
//    if (e.frmfkWholesalerID.value > 0) {
//        var r = document.getElementsByName("frmShippingGateway[]");
//        if (0 == IsChecked(r))
//            return alert("Shipping Gateway is Required !"), r[0].focus(), !1
//    }
    if (adit == 0) {
...
function validateShipplingGatewaysForm(e) {


    var minWeight = document.getElementsByName("minWeight[]"), maxWeight = document.getElementsByName("maxWeight[]"), price = document.getElementsByName("price[]"), frmShippingMultiCountryID = document.getElementsByName("frmShippingMultiCountryID[]");
    if ("" == e.pkAdminID.value || "0" == e.pkAdminID.value)
        return alert("Country Portal is Required!"), e.pkAdminID.focus(), !1;
    if ("" == e.frmShippingGatewayID.value || "0" == e.frmShippingGatewayID.value)
        return alert("Shipping gateway is Required!"), e.frmShippingGatewayID.focus(), !1;
    if (!(minWeight.length > 0))
        return!0;
    //console.log(minWeight.length);

    var CountryIDArray = [];
    var MinWeightIDArray = [];
    var MaxWeightIDArray = [];

    for (var f = 0; f < minWeight.length; f++) {
        //console.log(minWeight[f].value);
        if (0 == frmShippingMultiCountryID[f].value)
            return alert("Country is Required!"), frmShippingMultiCountryID[f].focus(), !1;
        //For Min. weight
        if ("" == minWeight[f].value)
            return alert("Min. Weight is Required!"), minWeight[f].focus(), !1;
        if (minWeight[f].value < 0)
            return alert("Min. Weight should not be less then 1!"), minWeight[f].focus(), !1;
        if (0 == AcceptDecimal(minWeight[f].value))
            return alert("Please Enter numeric or decimal value!"), minWeight[f].select(), !1;
        //For max wright
        if ("" == maxWeight[f].value)
            return alert("Max. Weight is Required!"), maxWeight[f].focus(), !1;
        if (maxWeight[f].value < 0)
            return alert("Max. Weight should not be less then 1!"), maxWeight[f].focus(), !1;
        if (0 == AcceptDecimal(maxWeight[f].value))
            return alert("Please Enter numeric or decimal value!"), maxWeight[f].select(), !1;
        //For price
        if ("" == price[f].value)
            return alert("price is Required!"), price[f].focus(), !1;
        if (price[f].value < 0)
            return alert("price should not be less then 1!"), price[f].focus(), !1;
        if (0 == AcceptDecimal(price[f].value))
            return alert("Please Enter numeric or decimal value!"), price[f].select(), !1;
        //Min weight should less than max weight
        //console.log(parseInt(minWeight[f].value), typeof(maxWeight[f].value));
        if (parseInt(minWeight[f].value) >= parseInt(maxWeight[f].value))
            return alert("Min. weight should less than max. weight!!"), minWeight[f].focus(), !1;

        CountryIDArray.push(frmShippingMultiCountryID[f].value);
        MinWeightIDArray.push(minWeight[f].value);
        MaxWeightIDArray.push(maxWeight[f].value);
    }

    $.post("ajax.php", {
        action: "AdminShippingPriceError",
        CountryIDArray: CountryIDArray,
        MinWeightIDArray: MinWeightIDArray,
        MaxWeightIDArray: MaxWeightIDArray,
    })
            .done(function (ee) {
                if (ee.trim() == 'fail') {
                    alert('Wrong weight combination with same country!');
                    return false;
                } else {
                    e.submit();
                    return true;
...
function validateShipplingGatewaysFormEdit(e) {
...
//    var result = num.toFixed();
    ...
    var MinWeightIDArray = [];
    var MaxWeightIDArray = [];
    var TotalCnt = minWeight.length - 1;

    if ((minWeight[TotalCnt].value != "") && (maxWeight[TotalCnt].value != "") && (price[TotalCnt].value != "")) {
        var cnt = minWeight.length;
    } else {
        var cnt = minWeight.length - 1;
    }

    for (var f = 0; f < cnt; f++) {
//        var num =  price[f].value.toNum();
        var PriceDigit = parseInt(price[f].value).toFixed().length;
        ...
        if (0 == AcceptDecimal(price[f].value))
            return alert("Please Enter numeric or decimal value!"), price[f].select(), !1;
        if (4 <= PriceDigit)
            return alert("Price should be in 3 digit!"), price[f].select(), !1;
        //Min weight should less than max weight
        //console.log(parseInt(minWeight[f].value), typeof(maxWeight[f].value));
        if (parseInt(minWeight[f].value) >= parseInt(maxWeight[f].value))
            return alert("Min. weight should less than max. weight!!"), minWeight[f].focus(), !1;
...
function showShippingPortal(e, t, r, frmShippingMultiCountryID) {

    console.log(r);
    $("#s2id_" + r + " a span:first").empty();
    $("#s2id_" + frmShippingMultiCountryID + " a span:first").empty();
    $("#" + frmShippingMultiCountryID).empty();
    $("#CountriesPortalID").val(e);

    0 == e || "" == e ? $("#" + r).html('<option value="0">Select Shipping Geteway</option>') : $.post("ajax.php", {
        action: "showShippingPortal",
        q: e,
        selId: t
    }, function (e) {
        $("#productRow tr").not(":first").not(":nth-child(2)").remove();
        $("#" + r).html(e)
        $("#AllowedCountries").html('')
        $("#CountriesCount").val('')
...
function showCountryState(e, t, r, thisObj) {

    //console.log(e);
    $("#country_id").val(e);
    0 == e || "" == e ? $("#" + r).html('<option value="0">Select State</option>') : $.post("../admin/ajax.php", {
        //url:"http://192.168.100.97/hemant/telamela/pro/ajax.php",
        action: "showCountryState",
        q: e,
        selId: t
    }, function (e) {

        $("#" + r).html(e).trigger("change");
        $(thisObj).parents('tr').find('td:eq(3)').find('select').trigger('change');
    })
}

function showStateCity(e, t, r, thisObj, j, i) {
...
//    iv1 = parseInt(i) + 1;
//    
    var frmCountSize = $('.controles_' + j + ' .DyZoneDiv_' + j).find('.table').size();
    var countTable = parseInt(frmCountSize) - 2;
    var frmcityid = $('.controles_' + j + ' .DyZoneDiv_' + j).find('.table').eq(countTable).find('.citycheck :selected').val();

    0 == e || "" == e ? $("#" + r).html('<option value="0">Select City</option>') : $.post("../admin/ajax.php", {
        //url:"http://192.168.100.97/hemant/telamela/pro/ajax.php",
        action: "showStateCity",
        q: e,
        selId: t
    }, function (e) {
        ...
        $("#" + r).html(e).trigger("change");
        console.log($('#frmStateid_' + j + '_' + i + ' :selected').text(), $(e + ' option').size(), '12121');
        if ($(e + ' option').size() == 1) {
            $('frmdistance_' + j + '_' + i).attr('disabled', 'disabled');
        }
        //$( e ).parents('tr').find('td:eq(3)').find('select').trigger('change');

        if (randomCityVar) {

            $('#frmcityid_' + j + '_' + i + ' option').filter(function () {
                return ($(this).val() == frmcityid);
...
$(document).on('click', '.minuseditRemove', function () {

    if (confirm('Are you sure you want to delete this')) {
        var minusI = $(this).attr('minusI');
        var minusJ = $(this).attr('minusJ');
        var fkzoneid = $(this).attr('id');
        $.post("../admin/ajax.php", {
            action: "removezonetabledata",
            data: {id: fkzoneid},
        }, function (e) {
...
$(document).on('click', '.zoneeditRemove', function () {
    if (confirm('Are you sure you want to delete this')) {
        var zoneid = $(this).attr('zoneid');
        $.post("../admin/ajax.php", {
            action: "removezonecompletedata",
            data: {zoneid: zoneid},
        }, function (e) {
            // $(".sucessmsg").html("<b> Title Changed Successfully</b>!");
            //$(".close").click();
...
$(document).on('click', '.addnewzone', function () {
    var iv = $(this).attr('valueOfI');
    var jv = $(this).attr('valueOfJ');
    iv1 = parseInt(iv) + 1;
    $(this).attr('valueOfI', iv1);
    //jv1 = parseInt(jv) + 1;

    var frmcountryid = $('.controles_' + jv + ' .DyZoneDiv_' + jv).find('.table').last().find('.countrycheck :selected').val();
    var frmstateList = $('.controles_' + jv + ' .DyZoneDiv_' + jv).find('.table').last().find('.statecheck').html();
    var frmstateid = $('.controles_' + jv + ' .DyZoneDiv_' + jv).find('.table').last().find('.statecheck :selected').val();

    var frmcityList = $('.controles_' + jv + ' .DyZoneDiv_' + jv).find('.table').last().find('.citycheck').html();
    var frmcityid = $('.controles_' + jv + ' .DyZoneDiv_' + jv).find('.table').last().find('.citycheck :selected').val();

//    var frmStateid = $("#frmStateid_" + jv + '_' + iv).val();
//    var frmcityid = $("#frmcityid_" + jv + '_' + iv).val();
//    var frmdistance = $("#frmdistance_" + jv + '_' + iv).val();

    $.post("../logistic/zone_html.php", {
        //action: "showStateCity",
        frmcountryid: frmcountryid,
        frmStateid: frmstateid,
        frmcityid: frmcityid,
        //frmdistance: frmdistance,
        i: iv,
        j: jv,
    }, function (e) {
        console.log(jv, iv1, frmstateList, frmcityid);
        $(".controles_" + jv + " .DyZoneDiv_" + jv).append(e);
        $('#frmStateid_' + jv + '_' + iv1).html(frmstateList);
        $('#frmStateid_' + jv + '_' + iv1 + ' option').filter(function () {
            return ($(this).val() == frmstateid);
        }).attr('selected', true).trigger("change");

        randomCityVar = true;

//        $('#frmcityid_' + jv + '_' + iv1).html(frmcityList);
//        $('#frmcityid_' + jv + '_' + iv1 + ' option').filter(function () {
//            return ($(this).val() == frmcityid);
//        }).attr('selected', true).trigger("change");
...
$(document).on('click', '.addnewzoneAdmin', function () {
    var iv = $(this).attr('valueOfI');
    var jv = $(this).attr('valueOfJ');
    iv1 = parseInt(iv) + 1;
    $(this).attr('valueOfI', iv1);
...
//function recuesiveNoZone(noOfZone) {
//
//
//    if (!inArray(noOfZone, noOfZones)) {
//
//        noOfZones.push(noOfZone);
//        return noOfZone;
//    } else {
//        noOfZone++;
//        recuesiveNoZone(noOfZone);
//    }
//}

$(document).on('click', '.addnewzonebolck', function () {
    var jv = $(this).attr('valueOfJ');
    var jv1 = parseInt(jv) + 1;
    $(this).attr('valueOfJ', jv1);

//    var noZone = $('#noOfZoneField').val();
//    var noZone1 = parseInt(noZone) + 1;
//    $('#noOfZoneField').val(noZone1);

    var noOfZone = $(".h4Edit").size();
    if (noOfZones.length != 0) {
        var maxArray = Math.max.apply(Math, noOfZones);
        var maxArray1 = Math.max.apply(Math, noOfZones);

    } else {
        var maxArray = 0;
        var maxArray1 = 0;
    }
//    var noZone = recuesiveNoZone(noOfZone);


    $.post("../logistic/zoneblock_html.php", {
//        c: frmcountryid,
//        s: frmStateid,
//        ci: frmcityid,
//        d: frmdistance,
        ...
        //$("#" + r).html(e)
        $(".multiplezonebolck").append(e)

        $(".controls1 .h4ZoneEdit").each(function (index) {

            var index = parseInt(index) + 1;
            maxArray = parseInt(maxArray) + 1;
            if (maxArray != 0) {
                $(this).text('zone' + maxArray);
            } else {
                $(this).text('zone' + index);
            }
        });
        $(".zonetitle").each(function (index) {

            var index = parseInt(index) + 1;
            maxArray1 = parseInt(maxArray1) + 1;
            if (maxArray1 != 0) {
                $(this).val('zone' + maxArray1);
            } else {
                $(this).val('zone' + index);
            }
        });
...
$(document).on('click', '.addnewzonebolckAdmin', function () {
    var jv = $(this).attr('valueOfJ');
    var jv1 = parseInt(jv) + 1;
    $(this).attr('valueOfJ', jv1);
...
//    var noZone = recuesiveNoZone(noOfZone);
    ...
    $.post("../logistic/zoneblockadmin_html.php", {
//        c: frmcountryid,
//        s: frmStateid,
//        ci: frmcityid,
//        d: frmdistance,
...
function validateprice() {
    ...
    var CombineIDArray = [];
    var error = false;
    var count = $('.control-block .table').size();
    var zoneid = document.getElementsByName("zoneid[]");
    var shipMethod = document.getElementsByName("shippingmethod[]");
    ...
    var minweight = document.getElementsByName("minweight[]");
    var maxweight = document.getElementsByName("maxweight[]");
    var cost = document.getElementsByName("cost[]");
    var deliveryday = document.getElementsByName("deliveryday[]");
    var handlingcost = document.getElementsByName("handlingcost[]");
    var fragilecost = document.getElementsByName("fragilecost[]");
    var cubic = document.getElementsByName("cubic[]");

    for (var f = 0; f < count; f++) {

        if ($.trim($(zoneid[f]).val()) == '')
        {
            $(zoneid[f]).focus();
            alert('Value Required');
            return false;
        } else {
            ZoneIDArray.push($(zoneid[f]).val());
        }
        if ($.trim($(shipMethod[f]).val()) == '')
        {
            $(shipMethod[f]).focus();
            alert('Value Required');
            return false;
        } else {
            MethodIDArray.push($(shipMethod[f]).val());
        }
        if ($.trim($(length[f]).val()) == '' || Number($(length[f]).val()) < 0)
        {
            $(length[f]).focus();
            alert('Positive Numeric Value Required');
            return false;
        }
        if ($.trim($(width[f]).val()) == '' || Number($(width[f]).val()) < 0)
        {
            $(width[f]).focus();
            alert('Positive Numeric Value Required');
            return false;
        }
        if ($.trim($(height[f]).val()) == '' || Number($(height[f]).val()) < 0)
        {
            $(height[f]).focus();
            alert('Positive Numeric Value Required');
            return false;
        }
        if ($.trim($(minweight[f]).val()) == '' || Number($(minweight[f]).val()) < 0)
        {
            $(minweight[f]).focus();
            alert('Positive Numeric Value Required');
            return false;
        }
        if ($.trim($(maxweight[f]).val()) == '' || Number($(maxweight[f]).val()) < 0)
        {
            $(maxweight[f]).focus();
            alert('Positive Numeric Value Required');
            return false;
        }
        if (Number($(minweight[f]).val()) >= Number($(maxweight[f]).val()))
        {
            $(minweight[f]).focus();
            alert('Min. weight should not be greater or equal to Max. weight');
            return false;
        }
        if ($.trim($(cost[f]).val()) == '' || Number($(cost[f]).val()) < 0)
        {
            $(cost[f]).focus();
            alert('Positive Numeric Value Required');
            return false;
        }
        if ($.trim($(handlingcost[f]).val()) != '')
        {
            if (Number($(handlingcost[f]).val()) < 0) {
                alert("Please Enter positive decimal value!");
                $(handlingcost[f]).focus();
                return false;
            }
        }
        if ($.trim($(fragilecost[f]).val()) != '')
        {
            if (Number($(fragilecost[f]).val()) < 0) {
                alert("Please Enter positive decimal value!");
                $(fragilecost[f]).focus();
                return false;
            }
        ...
        if ($.trim($(deliveryday[f]).val()) == '' || Number($(deliveryday[f]).val()) < 0)
        {
            $(deliveryday[f]).focus();
            alert('Positive Numeric Value Required');
            return false;
        ...
        var combineId = $(zoneid[f]).val() + '-' + $(shipMethod[f]).val();
        if (inArray(combineId, CombineIDArray)) {
            alert('Duplicate Combination.');
            return false;
        } else {
            CombineIDArray.push(combineId);
        }
    }
    console.log(CombineIDArray);
}
function showShippingCountryAllowed(e, t, r, pID) {

    $("#" + r).empty();
    $("#s2id_" + r + " a span:first").empty();

    0 == e || "" == e ? $("#" + r).html('<option value="0">Select Allowed Countries</option>') : $.post("ajax.php", {
        action: "showShippingCountryAllowed",
        q: e,
        selId: t,
        portalID: $('#CountriesPortalID').val(),
    }, function (e) {

        var res = $.parseJSON(e);
        $("#" + r).html(res.value)
        $("#AllowedCountries").html(res.value)
        $("#CountriesCount").val(res.count)
        $("#productRow tr").not(":first").not(":nth-child(2)").remove();
//        if(res.count == 1){
//            $(".PlusMinus").addClass('hide');
//        }else{
//            $(".PlusMinus").removeClass('hide');
//        }
    })
}
...
//       var selectedvalue = this.options[e.target.selectedIndex].text;
    var thisObj = $(this);
    var j = thisObj.attr('minusj');
    var i = thisObj.attr('minusi');

    var selectedvalue = $('#frmcityid_' + j + '_' + i + ' :selected').text();
//      var selectedvalue = $(thisObj+' option:selected').text();
    console.log(selectedvalue, j, i);
...

    {
        ...
        //var minusI = $(this).attr('minusI');
        //var minusJ = $(this).attr('minusJ');
//            $('#frmdistance_' + j + '_' + i).css('display', 'block');
        $('#frmdistance_' + j + '_' + i).removeAttr('disabled');
    } else {
//            $('#frmdistance_' + j + '_' + i).css('display', 'none');
        $('#frmdistance_' + j + '_' + i).attr('disabled', 'disabled');
...
$(document).on('change', '.citycheckto', function () {
...
//       var selectedvalue = this.options[e.target.selectedIndex].text;
    ...
    var selectedvalue = $('#tocityid_' + j + '_' + i + ' :selected').text();
//      var selectedvalue = $(thisObj+' option:selected').text();
    console.log(selectedvalue, j, i);
    ...
    {
//            $('#todistance_' + j + '_' + i).css('display', 'block');
        $('#todistance_' + j + '_' + i).removeAttr('disabled');
    } else {
//            $('#todistance_' + j + '_' + i).css('display', 'none');
        $('#todistance_' + j + '_' + i).attr('disabled', 'disabled');
    }

    //$('.PlusMinus_' + minusJ + '_' + minusI).remove();
});

$(document).on('click', ".minusRemovePrice", (function (e) {

//    $($(this)).parents('.TemplateBlock').fadeOut('slow');+

    var thisNow = $(this);

    $(thisNow).parents('.TemplateBlock').fadeOut(1000, function () {
        $(thisNow).parents('.TemplateBlock').remove();
        $('.control-block .TemplateBlock').last().find('.PlusMinus').css('display', 'block');
    });

    console.log($('.control-block .TemplateBlock').last().find('.PlusMinus').html());


}));
$(document).on('click', ".plusPriceForm", (function (e) {

    var thisVal = $(this);
    $.ajax({
        url: "../logistic/price_form_html.php", // Url to which the request is send
        ...
        {
            $(".control-block").append(data);
//            console.log($(thisVal).find('.PlusMinus').html());
            $(thisVal).parents('.PlusMinus').css('display', 'none');
            $('html, body').animate({
                scrollTop: $(".control-block .table:last").offset().top
            }, 2000);
            $("body").scrollTop(300);
...
//    $.post("../logistic/price_form_html.php", {
//        noOfZone: 'noOfZone',
//    }, function (e) {
//        console.log(e);
//    });
...
$(document).on('click', "#logisticList", (function (e) {

    var thisVal = $(this);
    var i = $(thisVal).attr('valueForI');
    var j = $(thisVal).attr('valueForJ');
    var frmcountryid = $('option:selected', thisVal).attr('country');

    $.post("ajax.php", {
        action: 'ListOfZones',
        LogisticId: thisVal.val(),
    }, function (e) {
        $('.h4ZoneEdit').text('zone' + e);
        $('.zonetitle').val('zone' + e);
        $('.firstTableDiv').css('display', 'block');
    });

    $('#frmcountryid_0_0').val(frmcountryid);
    ...
    $.post("ajax.php", {
        ...
        $("#frmStateid_0_0").html(e).trigger("change");
        //$(thisObj).parents('tr').find('td:eq(3)').find('select').trigger('change');
    })

//    $.post("../logistic/zone_html_admin.php", {
//        action: 'ListOfZones',
//        LogisticId: thisVal.val(),
//        i: i,
//        j: j,
...
$(document).on('click', ".plusPriceFormAdmin", (function (e) {

    var thisVal = $(this);
    var logisticId = $('#logisticValueHidden').val();
    console.log(logisticId);
    $.ajax({
        url: "../logistic/price_form_admin_html.php", // Url to which the request is send
        type: "POST", // Type of request to be send, called as method
//        data: JSON.stringify({ 'logisticId': logisticId}),
...
function validateShipplingMethodForm(e) {
    if ("" == e.frmMethodName.value || "0" == e.frmMethodName.value)
        return alert("Name/Title is Required!"), e.frmMethodName.focus(), !1;
    // return"" == e.frmMethodName.value ? (alert("Name/Title is Required!"), e.frmMethodName.focus(), !1) 
    //: "" == $.trim(e.frmMethodCode.value) ? (alert("Code is Required!"), e.frmMethodCode.focus(), !1) : !0
}

function validateShipplingMethodFormcopy(e) {
...
//    alert();
    var AdminUserName = document.getElementsByName("AdminUserName[]");
    var frmShippingName = document.getElementsByName("frmShippingName");
    var gatewayEmail = document.getElementsByName("gatewayEmail[]");
    if ("" == e.frmShippingName.value || "0" == e.frmShippingName.value)
        return alert("Shipping Title is Required!"), e.frmShippingName.focus(), !1;

    var PortalIDArray = [];
    var EmailIDArray = [];

    var ee = /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/;
    var TotalCnt = AdminUserName.length - 1;

    if ((AdminUserName[TotalCnt].value != "") && (gatewayEmail[TotalCnt].value != "")) {
        var cnt = AdminUserName.length;
    } else {
        var cnt = AdminUserName.length - 1;
    }

    for (var f = 0; f < cnt; f++) {

        if ("" == gatewayEmail[f].value)
            return alert("Email ID is Required!"), gatewayEmail[f].focus(), !1;
        if (!ee.test(gatewayEmail[f].value))
            return alert("Email arddress seems wrong!"), gatewayEmail[f].focus(), !1;


        //console.log(gatewayEmail[f].value,EmailIDArray);

        if ($.inArray(AdminUserName[f].value, PortalIDArray) >= 0) {
            alert('Duplicate country portal!');
            return false;
        }
        if ($.inArray(gatewayEmail[f].value, EmailIDArray) >= 0) {
            alert('Duplicate Email!');
            return false;
        }
        PortalIDArray.push(AdminUserName[f].value);
        EmailIDArray.push(gatewayEmail[f].value);
    }

}

function validateShipplingFormAdd(e) {
    ...
    var EmailIDArray = [];
    var ee = /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/;
    var cnt = $("select.count_me_baby").length;
    //alert(e.gatewayEmail.value);
//    return false;
//console.log(e.gatewayEmail.value);
    for (var f = 0; f < cnt; f++) {

        //console.log(e.gatewayEmail[f].value);
        if (cnt == 1) {

            if ("" == e.gatewayEmail.value)
                return alert("Email ID is Required!"), e.gatewayEmail.focus(), !1;
            if (!ee.test(e.gatewayEmail.value))
                return alert("Email arddress seems wrong!"), e.gatewayEmail.focus(), !1;

        } else {
            if ("" == e.gatewayEmail[f].value)
                return alert("Email ID is Required!"), e.gatewayEmail[f].focus(), !1;
            if (!ee.test(e.gatewayEmail[f].value))
                return alert("Email arddress seems wrong!"), e.gatewayEmail[f].focus(), !1;

            if ($.inArray(e.AdminUserName[f].value, PortalIDArray) >= 0) {
                alert('Duplicate country portal!');
                return false;
            }
            if ($.inArray(e.gatewayEmail[f].value, EmailIDArray) >= 0) {
                alert('Duplicate Email!');
                return false;
            }
            PortalIDArray.push(e.AdminUserName[f].value);
            EmailIDArray.push(e.gatewayEmail[f].value);
        }



        //console.log(AdminUserName[f].value,PortalIDArray);
...
function validateNotificationForm(e) {
    return"" == e.frmnotificationTitle.value || "0" == e.frmnotificationTitle.value ? (alert("Notification Title is Required!"), e.frmnotificationTitle.focus(), !1) : "" == $.trim(e.frmnotificationDescription.value) ? (alert("Notification Description is Required!"), e.frmnotificationDescription.focus(), !1) : "" == $.trim(e.frmnotificationUrl.value) ? (alert("Product Url is Required!"), e.frmnotificationUrl.focus(), !1) : !0
}

function validateShipplingCountryForm(e) {
    return"" == $.trim(e.pkAdminID.value) || "0" == e.pkAdminID.value ? (alert("Country Portal is Required!"), e.pkAdminID.focus(), !1) : "" == $.trim(e.frmShippingGatewayID.value) || "0" == e.frmShippingGatewayID.value ? (alert("Shipping Gateways is Required!"), e.frmShippingGatewayID.focus(), !1) : "" == $.trim(e.country_id.value) ? (alert("Countries is Required!"), e.country_id.focus(), !1) : !0
}
...
function validateKPISettingForm() {
    for (var e = document.getElementsByName("frmCountryId[]"), t = document.getElementsByName("frmKPIVal[]"), r = 1; r < e.length; r++) {
        if (0 == e[r].value)
            return alert("Please select country !"), e[r].focus(), !1;
        if (0 == t[r].value)
            return alert("Please select value!"), t[r].focus(), !1
    }
    return!0
}
...
function validateKPIPremiumSettingForm() {
    ...
    if (0 == e.value)
        return alert("Product sold required !"), e.focus(), !1;
    if (/^[0-9]+$/.test(e.value) == false && e.value != '')
        return alert("Enter numeric value for product sold!"), e.focus(), !1;
    if (0 == t.value)
        return alert("Kpi value required!"), t.focus(), !1;
    if (/^[0-9]+$/.test(t.value) == false && t.value != '')
        return alert("Enter numeric value for Kpi!"), t.focus(), !1;
    return!0
}
function validateMultipleProductAddForm() {
    ...
    if (0 == e.value)
        return alert("Plase Select Country!"), e.focus(), !1;
    if (0 == t.value)
        return alert("Plase Select Wholesaler!"), t.focus(), !1;
    if (t.value > 0) {
        var s = document.getElementsByName("frmShippingGateway[]");
        if (0 == IsChecked(s))
            return alert("Shipping Gateway is Required !"), s[0].focus(), !1
    }
    for (var m = 0; m < r.length; m++) {
        if ("" == i[m].value)
            return alert("Product Name is Required!"), i[m].focus(), !1;
        if ("" == r[m].value)
            return alert("Product Ref No. is Required!"), r[m].focus(), !1;
        if (1 == a[m].value)
            return alert("Product Ref No. allready Exist.Please Change!"), r[m].focus(), !1;
        if (r.length > 1)
            for (var c = 0; c < r.length; c++)
                if (r[m].value == r[c].value && m != c)
                    return alert("Product Ref No can not same!"), r[c].focus(), !1;
        if ("" == n[m].value)
            return alert("Price is Required!"), n[m].focus(), !1;
        if (parseFloat(n[m].value) <= parseFloat(nd[m].value))
            return alert("Discount price should be less than wholesaler price!"), nd[m].focus(), !1;
        if (0 == AcceptDecimal(n[m].value))
            return alert("Please Enter numeric or decimal value!"), n[m].focus(), !1;
        /*
         if(r.length>0){
        ...
        if ("" == l[m].value)
            return alert("Quantity is Required!"), l[m].focus(), !1;
        if (1 == IsDigits(l[m].value))
            return alert("Please Enter numeric value !"), l[m].focus(), !1;
        if ("" != o[m].value && 1 == IsDigits(o[m].value))
            return alert("Please Enter numeric value !"), o[m].focus(), !1;
        if (0 == IsLessThan(l[m].value, o[m].value))
            return alert("Sent alert message should be less than Stock Quantity !"), o[m].focus(), !1;
        if (0 == u[m].value)
            return alert("Please Select Category!"), u[m].focus(), !1;
        /*
...
function validateBulkUpload() {
    ...
    if ("" == e.value)
        return alert("Please Select what you want to upload!"), e.focus(), !1;
    if ($("#" + e.value + " .requiredUploadFields").each(function () {
        !this.checked && i && (alert("Please select the mandatory fields."), this.focus(), i = 0)
    }), 0 == i)
        return!1;
    if ("" == a.value)
        return alert("Please Select file!"), a.focus(), !1;
    if ("" != a.value) {
        var n = a.value, l = n.substring(n.lastIndexOf(".") + 1), l = l.toLowerCase();
        if ("xls" != l && "xlsx" != l && "csv" != l)
            return alert("Accepted File formats are: csv,xlsx,xls"), a.focus(), !1
    }
    if ("product" == e.value && "" == r.value)
        return alert("Please upload a zip file of images !"), r.focus(), !1;
    if ("product" == e.value) {
        var n = r.value, l = n.substring(n.lastIndexOf(".") + 1), l = l.toLowerCase();
        if ("zip" != l)
            return alert("Accepted File formats is: zip"), r.focus(), !1
    }
    if ("packages" == e.value && "" == t.value)
        return alert("Please upload a zip file of images !"), t.focus(), !1;
    if ("packages" == e.value) {
        var n = t.value, l = n.substring(n.lastIndexOf(".") + 1), l = l.toLowerCase();
        if ("zip" != l)
            return alert("Accepted File formats is: zip"), t.focus(), !1
    }
...
function validateCoupon(e) {
    if (!validateForm(e, "frmCouponCode", "Coupon Code", "R", "frmCouponPriceValue", "Price Value", "RisDecimal", "frmMinimumPurchaseAmount", "Minimum Purchase Amount", "RisDecimal", "frmCouponPriceValue", "Price Value", "regDecimal", "frmCouponActivateDate", "Coupon Activate date", "R", "frmCouponExpiryDate", "coupon expiry date", "R"))
        return!1;
...
function validateAdsAddPageForm(e, t) { //alert($("#frmCountry").val()); return false;
    ...
    if ("html" == r) {
        if ("" == trim($("#frmTitle").val()))
            return alert("Title is required!"), $("#frmTitle").focus(), !1;
        if ("" == trim($("#frmHtmlCode").val()))
            return alert("Html Code is required!"), $("#frmHtmlCode").focus(), !1;
        if ("" == trim($("#frmAdsPage").val()))
            return alert("Please select the page for advertiment!"), $("#frmAdsPage").focus(), !1;
        if ($('#countryIds').is(':visible')) {
            if ('' == $("#frmCountry").val())
                return alert("Country is required!"), $("#frmCountry").focus(), !1;
        }
        if ($('#addOrderIds').is(':visible')) {
            if ('0' == $("#addOrder").val())
                return alert("Order is required!"), $("#addOrder").focus(), !1;
        }
    } else {
        if ("" == trim($("#frmTitle").val()))
            return alert("Title is required!"), $("#frmTitle").focus(), !1;
        if ("" == trim($("#frmAdUrl").val()))
            return alert("URL Link is required!"), $("#frmAdUrl").focus(), !1;
        if ($('#countryIds').is(':visible')) {
            if ('' == $("#frmCountry").val())
                return alert("Country is required!"), $("#frmCountry").focus(), !1;
        }
        if (0 == IsUrlLink($("#frmAdUrl").val()))
            return alert("Please enter the valid URL link!"), $("#frmAdUrl").select(), !1;
        if (0 == t && "" == $("#frmImg").val())
            return alert("Image is required!"), $("#frmImg").focus(), !1;

        if (("Product Listing Page" == $("#frmAdsPage").val() || "Menu Category Image" == $("#frmAdsPage").val()) && null == $("#frmCategory").val())
            return alert("Please select category(s)!"), $("#frmCategory").focus(), !1;
        if ($('#addOrderIds').is(':visible')) {
            if ('0' == $("#addOrder").val())
                return alert("Order is required!"), $("#addOrder").focus(), !1;
        }
    }
    if (trim($('#frmAdsPrice').val()) != '' && (0 == AcceptDecimal($('#frmAdsPrice').val()) || parseInt($('#frmAdsPrice').val()) < 0))
        return alert("Please Enter numeric or decimal value!"), $('#frmAdsPrice').focus(), !1;
...
function validateBannerPageForm(t) {
    ...
    if (step == '1') {
        ...
        if ("" == $("#frmFestival").val())
            return alert("Please select festival!"), $("#frmFestival").focus(), !1;
        if ("" == $("#frmTitle").val())
            return alert("Banner title is required!"), $("#frmTitle").focus(), !1;
        if (0 == t && "" == $("#frmImg").val())
            return alert("Banner Image is required!"), $("#frmImg").focus(), !1;
        if ("" != $("#frmBannerOrder").val() && isNaN($("#frmBannerOrder").val()))
            return alert("Please enter numeric value for order!"), $("#frmBannerOrder").focus(), !1;
...
function validateFestivalPageForm(t) {
    if ("" == $("#frmTitle").val())
        return alert("festival title is required!"), $("#frmTitle").focus(), !1;
    if (null == $("#frmCountry").val())
        return alert("Please select country(s)!"), $("#frmCountry").focus(), !1;
    if (null == $("#frmCategoryId").val())
        return alert("Please select category(s)!"), $("#frmCategoryId").focus(), !1;
    if ("" != $("#frmBannerOrder").val() && isNaN($("#frmBannerOrder").val()))
        return alert("Please enter numeric value for order!"), $("#frmBannerOrder").focus(), !1;
}
...
function addDynamicRowToTableForShippingGateways1(e) {
...
function addDynamicRowToTableForShippingGateways(e) {
    ...
    var OptionSize = $('#AllowedCountries option').size();
    var Opt_no = $('#' + e + ' tr').size();
//    if(OptionSize > Opt_no){
    var t = document.getElementById(e), r = t.rows.length;
    var rowClone = $("#" + e + " tr:nth-child(2)").clone();
    var AllowedCountries = $('#AllowedCountries').html();

    var newHtml = "<tr>\n\
<td>\n\
<select name='frmShippingMultiCountryID[]' id='frmShippingMultiCountryID' class='select2-me input-large'>\n\\n\
//" + AllowedCountries + "\n\
</select>\n\
</td>\n\
...
<td><i><span style='cursor: pointer;width:51px;'  onclick=" + "addDynamicRowToTableForShippingGateways('" + e + "')>\n\
<img src='images/plus.png'/></span></i>\n\
<a onclick=" + "removeDynamicRowToTableForShippingGatewaysNew(this);>\n\
<img src='images/minus.png' />\n\
</td>\n\
</tr>";
    $("#" + e).append(newHtml);
//}else{
//    alert('No Counry is available ..');
//}

}

function addDynamicRowToTableForShippingGatewaysemail(e) {
...
//    var rowClone = $("#" + e + " tr:nth-child(2)").clone();
    ...
    var newHtml = "<tr>\n\
<td>\n\
<select name='AdminUserName[]' id='AdminUserName' class='select2-me count_me_baby input-large'>\n\\n\
//" + AllowedCountries + "\n\
</select>\n\
</td>\n\
<td><input type='text' name='gatewayEmail[]' id='gatewayEmail' ></td>\n\
<td><i><span style='cursor: pointer;width:51px;'  onclick=" + "addDynamicRowToTableForShippingGatewaysemail('" + e + "')>\n\
<img src='images/plus.png'/></span></i>\n\
<a onclick=" + "removeDynamicRowToTableForShippingGatewaysNewEditEmail(this);>\n\
<img src='images/minus.png' />\n\
</td>\n\
</tr>";
    $("#" + e).append(newHtml);
...
function addDynamicRowToTableForShippingGatewaysEdit(e) {

    var OptionSize = $('#AllowedCountries option').size();
//    var Opt_no = $('#'+e+' tr').size();
    var Opt_no = $('.newTrEdit').size();
    //console.log(OptionSize, Opt_no);
    //if(OptionSize > Opt_no){
    var t = document.getElementById(e), r = t.rows.length;
    var rowClone = $("#" + e + " tr:nth-child(2)").clone();
    var AllowedCountries = $('#AllowedCountries').html();

    var newHtml = "<tr class='newTrEdit'>\n\
<td>\n\
<select name='frmShippingMultiCountryID[]' id='frmShippingMultiCountryID' class='select2-me input-large'>\n\\n\
//" + AllowedCountries + "\n\
</select>\n\
...
<td><input type='text' name='maxWeight[]' id='maxWeight' ></td>\n\
<td><input type='text' name='price[]' id='price' ></td>\n\
<td><i><span style='cursor: pointer;width:51px;'  onclick=" + "addDynamicRowToTableForShippingGatewaysEdit('" + e + "')>\n\
<img src='images/plus.png'/></span></i>\n\
<a onclick=" + "removeDynamicRowToTableForShippingGatewaysNew(this);return false;>\n\
<img src='images/minus.png' />\n\
</td>\n\
</tr>";
    $("#" + e).append(newHtml);
...
function removeDynamicRowToTableForShippingGatewaysNew(text, PKid, PortalID, GateID, CountryID, MinWg, MaxWg) {
...
function removeDynamicRowToTableForShippingGatewaysNewEditEmail(text, PKid, PortalID) {
...
function validateAttributeAddPageForm(frm, addit) {
    ...
    if ("" == $("#frmAttributeCode").val())
        return alert("Attribute Code is required!"), $("#frmAttributeCode").focus(), !1;
    if ("0" == $("#isUniqueCode").val())
        return alert("Attribute Code already Exist. Please change!"), $("#frmAttributeCode").select(), !1;
    if ("" == $("#frmAttributeTitle").val())
        return alert("Attribute Label is required!"), $("#frmAttributeTitle").focus(), !1;
    // if ($("#frmInputType").val() == 'image' && addit == 0) {
    //     var f = document.getElementsByName("attr_img[]");
    //     for (var t = 0; t < f.length; t++)
    //         if (0 == f[t].value)
    //             return alert("Please select image!"), f[t].focus(), !1;
    // }
    for (var t = 0; t < e.length; t++)
        if (0 == e[t].value)
            return alert("Please select Category!"), e[t].focus(), !1;
...
function validateFileExtensionNew(e, t, r, a) {
    ...
    for (i = 0; i < t.length; i++)
        allowedEx = t[i].toUpperCase(), a = a + allowedEx + ",";
...
function validateEnquiryEmailsForm() {
    ...
    if ("" == document.frmAddEditEmail.frmEnquiryEmail.value)
        return alert("Please enter email address!"), document.frmAddEditEmail.frmEnquiryEmail.focus(), !1;
    if ("" != document.frmAddEditEmail.frmEnquiryEmail.value)
        for (var t = document.frmAddEditEmail.frmEnquiryEmail.value.split(","), r = 0; r < t.length; r++)
            if (!e.test(t[r]))
                return alert(t[r] + " Email arddress seems wrong!"), document.frmAddEditEmail.frmEnquiryEmail.focus(), !1
}
function getRBtnName(e) {
    for (var t = document.getElementsByName(e), r = -1, a = "", i = 0; i < t.length; i++)
        1 == t[i].checked && (a = t[i].value, r = i);
    return r
}
function validateUser(e) {
    return validateForm(e, "frmTitle", "Title", "R", "frmFirstName", "User Name", "R", "frmUserEmail", "Email Address ", "RisEmail", "frmPassword", "Password", "R", "frmPassword", "Password ", "isMin", "frmConfirmPassword", "Confirm Password ", "RisEqualfrmPassword: Password ", "frmAdminRoll", "Role", "R", "frmCommission", "Commission", "R", "frmSalesTarget", "Sales Target", "R", "frmSalesTargetStartDate", "Sales Target Date", "R") ? !0 : !1
}
function validateLogistic(e) {
    return validateForm(e, "frmTitle", "Company Name", "R", "CountryPortalID", "Country Portal ", "R", "frmFirstName", "User Name", "R", "frmUserEmail", "Email Address ", "RisEmail", "frmPassword", "Password", "R", "frmPassword", "Password ", "isMin", "frmConfirmPassword", "Confirm Password ", "RisEqualfrmPassword: Password ", "CountryPortalID12", "CountryPortal123", "R", "frmCommission", "Commission", "R", "frmSalesTarget", "Sales Target", "R", "frmSalesTargetStartDate", "Sales Target Date", "R") ? !0 : !1
}
    ...
    r.countryID = e, r.selected = t, $.post(SITE_ROOT_URL + "common/ajax/ajax.php", r, function (e) {
        if (e) {
            if ($("#frmShippingCostState").is(":visible"))
                return $("#frmShippingCostState").html(e).show(), !0;
            if ($("#frmState").is(":visible"))
                return $("#frmState").html(e).show(), !0
        }
    })
}
...
function checkCondition(e, t) {
    for (var r = document.getElementById("ProductSizecount").value, a = 0; r > a; a++)
        if (a != t) {
...
function validateNewsletterAddForm() {
    ...
    if (("<br>" == $.trim($('#cke_frmHtmlEditor iframe').contents().find('.cke_editable').html()) || "<p><br></p>" == $.trim($('#cke_frmHtmlEditor iframe').contents().find('.cke_editable').html()) || "<p><br><br></p>" == $.trim($('#cke_frmHtmlEditor iframe').contents().find('.cke_editable').html())) && $('#template').val() == '')
        return alert("Content is required!"), $("#frmHtmlEditor").focus(), !1;
    ...
    if (e.length > 0)
        for (var t = 0; t < e.length; t++) {
            ...
            if ("" != r) {
                ...
                if ("jpg" != i && "jpeg" != i && "gif" != i && "png" != i)
                    return alert("Accepted Image formats are: jpg, jpeg, gif, png"), e[t].focus(), !1
            }
        }
    if ("" == $.trim($("#frmDeliveryDate").val()))
        return alert("Schedule Delivery Time is required!"), $("#frmDeliveryDate").focus(), !1;
    if ("00" == $.trim($("#frmHH").val()))
        return alert("HH is required!"), $("#frmHH").focus(), !1;
    if ("00" == $.trim($("#frmMM").val()))
        return alert("MM is required!"), $("#frmMM").focus(), !1;
    var n = 0;
    if ($(".recipient").each(function () {
        $(this).is(":checked") && n++
    }), 0 == n)
        return alert("Please checked checkbox!"), !1;
    var l = 0;
...
function validateCustomerCompose() {
    ...
    return "" == $("#autoFilledCustomer").val() ? (alert("Customer Email is required!"), $("#autoFilledCustomer").focus(), !1) : "0" == $("#frmSupportType").val() ? (alert("Type is required!"), $("#frmSupportType").focus(), !1) : "" == $("#frmSubject").val().trim() ? (alert("Subject is required!"), $("#frmSubject").focus(), !1) : "" == $("#frmMessage").val().trim() ? (alert("Message is required!"), $("#frmMessage").focus(), !1) : void 0
}
...
function validatePaypalEmail() {
    var e = $("#frmEmail").val();
    if ("" == $("#frmEmail").val())
        return alert("Email Id is required!"), !1;
...
function getPric(ids, inc, p) {
    ...
    var r, a, n = 0;
    var frmPrice1 = document.getElementsByName('frmPrice[]');
    for (r = 1; r <= frmPrice1.length; r++) {
        a = parseFloat($('#price' + r).find('b').html());
        console.log(a);
        n += a;
    }
